...
$(function () 
{
	...
	{
		disInsJob();
		$("#onelevel").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
	})
	...
	$("#app_onelevel").change(function()
	{
		disAppJob();
		$("#app_onelevel").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
		$("#onelevel").siblings(".mySelf").val($(this).find("option:selected").text());
	})
	
	$("#appntOccupation3").change(function()
    {
    	$("#appntOccupation3_dummy").val($("#appntOccupation3").find("option:selected").text());
    	$("#appntOccupation3").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    	$("#occupation").siblings(".mySelf").val($(this).find("option:selected").text());
    })
    
    $("#appincomtype").change(function()
    {
    	$("#appincomtype").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    	$("#insincomtype").siblings(".mySelf").val($(this).find("option:selected").text());
    })
    
    $("#appincom").change(function()
    {
    	$("#appincom").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    	$("#insincom").siblings(".mySelf").val($(this).val());
    })
    
    $("#appnt_height").change(function()
    {
    	$("#appnt_height").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    	$("#height").siblings(".mySelf").val($(this).val());
    })
    
    $("#appnt_weight").change(function()
    {
    	$("#appnt_weight").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    	$("#weight").siblings(".mySelf").val($(this).val());
    })
    
    $("#insincomtype").change(function()
    {
    	$("#insincomtype").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    })
    
    $("#insincom").change(function()
    {
    	$("#insincom").parent().siblings(".errorMsg").css("display", "inline-block").text("").hide();
    })
    ...
    $("#ishuomian").on("change", function () {
    	$("#ishuomian_dummy").val($("#ishuomian").find("option:selected").text());
    	...
    	{
    		$("#hmtk").css("display", "none")
    	}
    })
    
    $("#iszl").on("change", function () 
    {
    	if($("#iszl").val()=="Y")
    	{
    		$("#zltk").css("display", "")
...
//                        console.log($(".appntOccupation").find("option:selected").text())
            ...
            $("#ishuomian").html('')
            $("#ishuomian").append("<option value='N'>不投保</option>");
            ...
            $("#ishuomian").html('');
            $("#ishuomian").append("<option value='Y'>投保</option>");
            $("#ishuomian").append("<option value='N'>不投保</option>");
...
//    	}
    	...
    	/*
    	alert($("#appntOccupation3").find("option:selected").val())
    	return;
    	*/
    	
    	if($("#onlychinesetax").val()!="10")
    	{
    		$(".pop").show();
	       	$(".mask").show();
	       	$(".pop span").text("税收身份仅为中国大陆税收居民，才能投保！");
	       	return;
    	}
    	
    	if(!checkAll()) return;
    	
    	if($("#relation").val()=="00"&&$("#ishuomian").val()=="Y")
    	{
    		$(".pop").show();
	       	$(".mask").show();
	       	$(".pop span").text("被保险人是本人时，不能购买附加豁免险！");
	       	return;
    	}
        ...
        sendRequest("../../life/hongkang/newcontract_save.do",getData(),function (data) {
        	console.log(data);
        	var obj = JSON.parse(data);
        	if(obj.code == 0){
        		var orderNo = obj.orderNo;
        		console.log(orderNo);
        		window.location.href = "../../life/hongkang/contractpay.do?orderNo="+orderNo;
            }else{
            	$(".pop").show();
            	$(".mask").show();
            	$(".pop span").text(obj.msg);
    ...
    */
    ...
    $("#payendyear").change(function()
    {
    	...
    	//alert($("#ishuomian").val());
    	//alert($("#ishuomian").get(0).selectedIndex);
		//alert($("#ishuomian").find("option:selected").text());
    });
});
...
//投保人信息
    ...
    if ($("#app_onelevel").find("option:selected").val()== null || $("#app_onelevel").find("option:selected").val() == "") 
    {
        $("#app_onelevel").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择行业！");
        flag = false;
    }
    
    if ($("#appntOccupation3").find("option:selected").val()== null || $("#appntOccupation3").find("option:selected").val() == "") 
    {
        $("#appntOccupation3").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择职业！");
        flag = false;
    }
    
    if ($("#appincomtype").find("option:selected").val()== null || $("#appincomtype").find("option:selected").val() == "") 
    {
        $("#appincomtype").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择年收入类型！");
        flag = false;
    }
    
    if ($("#appincom").val()== null || $("#appincom").val() == "") 
    {
        $("#appincom").parent().siblings(".errorMsg").css("display", "inline-block").text("请填写年收入！");
        flag = false;
    }
    
    if ($("#appnt_height").length>0) {
        if (!checkHeight($("#appnt_height"))) {
            flag = false;
        }
    }
    
    if ($("#appnt_weight").length>0) {
        if (!checkWeight($("#appnt_weight"))) {
            flag = false;
        }
    }
    ...
    if (true) {
        if ($("#relation").find("option:selected").text() != "本人") {
            ...
            if ($("#onelevel").find("option:selected").val()== null || $("#onelevel").find("option:selected").val() == "") 
            {
                $("#onelevel").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择行业！");
                flag = false;
            }
            
            if ($("#occupation").find("option:selected").val()== null || $("#occupation").find("option:selected").val() == "") 
            {
                $("#occupation").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择职业！");
                flag = false;
            }
            
            if ($("#insincomtype").find("option:selected").val()== null || $("#insincomtype").find("option:selected").val() == "") 
            {
                $("#insincomtype").parent().siblings(".errorMsg").css("display", "inline-block").text("请选择年收入类型！");
                flag = false;
            }
            
            if ($("#insincom").val()== null || $("#insincom").val() == "") 
            {
                $("#insincom").parent().siblings(".errorMsg").css("display", "inline-block").text("请填写年收入！");
                flag = false;
            }
...
function getData()
{
	var data = 
	{
		...
		"payintv":$("#payintv").find("option:selected").val(),
		"ishuomian":$("#ishuomian").find("option:selected").val(),
		"iszjyl":$("#iszjyl").find("option:selected").val(),
		"isexzl":$("#isexzl").find("option:selected").val(),
		"isdbbjb":$("#isdbbjb").find("option:selected").val(),
		//计算保费的时候，用的producttype，其他的时候，用的isabzkx
		"isabzkx":$("#isabzkx").find("option:selected").val(),
		"producttype":$("#isabzkx").find("option:selected").val(),
		"bankname":$("#accountBank").find("option:selected").text()
	};
    ...
    if($("#relation").val()!="00") 
    {
    	oObj["age"] = getAgeByBirthDay($("#insuredBirthday").val());
	}
    else
    {
    	oObj["age"] = getAgeByBirthDay($("#birthday").val());
    }
    
    if($("#relation").val()!="00") 
    {
    	oObj["insuredSex"] = $("#insuredSex").val();
	}
    else
    {
    	oObj["insuredSex"] = $("#sex").val();
    }
    
    oObj["appntage"] = getAgeByBirthDay($("#birthday").val());
    oObj["appntsex"] = $("#sex").val();
    
    var allData = $.extend(data, oObj);
    
    /*
    allData["appntProvince"] = '310000';
    allData["appntCity"] = '310100';
    allData["appntCounty"] = '310112';
    */
...
function calPrice()
{
	...
	if($("#relation").val()!="00")
	{
		...
		if ($("#insuredSex").val()==null|| $("#insuredSex").val()=="") 
		{
			return ;
		}
	}
	...
	sendPriceRequest("../../life/hongkang/calprem.do",getData(),function (data) 
	{
    	var obj = JSON.parse(data);
    	console.log(obj);
    	...
    	if(obj.code == 0)
    	{
    		$("#prem").val(Number(obj.sumPrem).toFixed(2));
    		$("#sumPrem").val(Number(obj.sumPrem).toFixed(2));
    		$("#insurePrice").html(Number(obj.sumPrem).toFixed(2));
    		
    		$("#mainPrice").val(Number(obj.mainPrem).toFixed(2));
    		$("#zjylPrice").val(Number(obj.zjylPrem).toFixed(2));
    		$("#exzlPrice").val(Number(obj.exzlPrem).toFixed(2));
    		$("#dbbjbPrice").val(Number(obj.dbbjbPrem).toFixed(2));

    		$("#hmPrice").val(Number(obj.hmPrem).toFixed(2));
    		$("#hmAmnt").val(Number(obj.hmAmnt).toFixed(2));
    	}
    	else
    	{
    		$(".pop").show();
...
function disInsJob()
{
	sendRequest("../../life/hongkang/getJobCode.do",
			{"onelevel":$("#onelevel").find("option:selected").val()},
			function (data) 
	{
	   	console.log(data);
	   	var obj = JSON.parse(data);
	   	if(obj.code == 0)
	   	{
	   		...
	   		$("#occupation").append("<option value='0'>请选择</option>");
	   		for(var i=0;i<obj.jobList.length;i++)
	   		{
	   			$("#occupation").append("<option value='"+obj.jobList[i].jobcode+"'>"+obj.jobList[i].jobname+"</option>");
	   		}
...
{
	sendRequest("../../life/hongkang/getJobCode.do",
			{"onelevel":$("#app_onelevel").find("option:selected").val()},
			function (data) 
	{
	   	console.log(data);
	   	var obj = JSON.parse(data);
	   	if(obj.code == 0)
	   	{
	   		$("#appntOccupation3").html('')
	   		$("#appntOccupation3").val('');
	   		$("#appntOccupation3_dummy").val($("#appntOccupation3").find("option:selected").text());
	   		
	   		$("#appntOccupation3").append("<option value='0'>请选择</option>");
	   		for(var i=0;i<obj.jobList.length;i++)
	   		{
	   			$("#appntOccupation3").append("<option value='"+obj.jobList[i].jobcode+"'>"+obj.jobList[i].jobname+"</option>");
	   		}
		       		
	   		$("#appntOccupation3").val('0');
	   		$("#appntOccupation3_dummy").val($("#appntOccupation3").find("option:selected").text());
	    }
	   	else
	   	{
