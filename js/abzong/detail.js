...
{
	window.location.href = "../../life/abz/nc_cqs.do";
}
function newcontractsel()
{
	window.location.href = "../../life/abz/nc_sel.do";
}
function calprice()
{
	...
	sendRequest("../../life/abz/getprice02.do",transdata,function (data) 
	{
		var obj = JSON.parse(data);
	   	console.log(obj);
	   	if(obj.code == '0')
	   	{
	   		$("#insurePrice").val(obj.sumprem);
	   	}
	   	else
	   	{
