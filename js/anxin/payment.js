...
//      提交form表单
        $(".loading").show();
//        $("#payTypeForm").attr("action", "https://axwxtest.95303.com/axPay/pay/unusual");//测试地址 
        $("#payTypeForm").attr("action", "https://weixin.95303.com/axPay/pay/unusual"); //正式
        $("#payTypeForm").submit();
...
//        }
//        
//        sendRequest("../../life/anxin/contractpay_save.do",{"orderNo":$("#orderNo").val()},function(data)
//        {
