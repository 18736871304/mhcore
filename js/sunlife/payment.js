$(function () {
    ...
    */
    ...
    $(".insureBtn").on("click", function () 
    {
        ...
        sendRequest("../../life/sunlife/contractpay_save.do",{"orderNo":$("#orderNo").val()},function(data)
        {
            ...
            if(obj.code == 0){
            	...
            	//测试
            	//window.location.href = "http://pay.ygbx.yghsh.com/index.html?orderNo="+obj.orderNo+"&channelSign="+obj.key;
            	
            	//正式
            	window.location.href = "https://pay.ygibao.com/index.html?orderNo="+obj.orderNo+"&channelSign="+obj.key;
            }else{
            	$(".pop").show();
            	$(".mask").show();
