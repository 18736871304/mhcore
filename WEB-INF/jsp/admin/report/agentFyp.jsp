		...
		<head>
			...
			<script>
				...
				function fypquery(orderbystr, insType) {
					...
					// if(orderbystr=="policycountorder" && insType=='long'){
					// 	tParam.riskTypeStr = "03,04,05";
					// }else if(orderbystr=="policycountorder" && insType=='yi') {
					// 	tParam.riskTypeStr = "02";
					// } 

					// if(orderbystr=="sumfyp20order" && insType=='long'){
					// 	tParam.riskTypeStr = "03,04,05";
					// }else if(orderbystr=="sumpremorder" && insType=='yi') {
					// 	tParam.riskTypeStr = "02";
					// } 
