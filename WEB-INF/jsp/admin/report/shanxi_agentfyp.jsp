...
<div style="margin-left:0%">
	...
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" id = "fypquery" onclick = "fypquery('policycountorder')">按单数排名</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" id = "fypquery" onclick = "fypquery('sumfyp20order')">按标保排名</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" id = "fypquery" onclick = "fypquery('sumpremorder')">按保费排名</a>
	<br>
	<br>
