				...
				<div id="displayORno">
					...
					<table class="common">
						<tr>
							...
							<td class="report_common_4">
								<select class="easyui-combobox" style="width:160%" panelHeight="auto"
									name="payendyearflag" id="payendyearflag" notnull="缴费年期单位">
								</select>
							</td>
					...
					<br>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id="payendyearInsert"
						onclick="payendyearInsert()">缴费年期录入</a>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id="payendyearUpdate"
						onclick="payendyearUpdate()">缴费年期修改</a>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id="payendyearDelete"
						onclick="payendyearDelete()">缴费年期删除</a>
				</div>
			</div>
		</body>
