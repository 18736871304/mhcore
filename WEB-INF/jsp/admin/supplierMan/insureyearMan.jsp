		...
		<body>
			<div style="margin-left:0%">
				...
				<div id="displayORno">
						...
						<tr>
							...
							<td class="report_common_4">
								<select class="easyui-combobox" style="width:160%" panelHeight="auto"
									name="insureyearflag" id="insureyearflag" notnull="保障期限单位">
								</select>
							</td>
					...
					<br>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id="insureyearInsert"
						onclick="insureyearInsert()">保障期限录入</a>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id="insureyearUpdate"
						onclick="insureyearUpdate()">保障期限修改</a>
					<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id="insureyearDelete"
						onclick="insureyearDelete()">保障期限删除</a>
				</div>
