...
function answerUpdate()
{
	...
	tparam.answer_userid = row.answer_userid;
	tparam.zd_answer_userid = row.zd_answer_userid;
	tparam.answer = html;

	ajaxdeal("qa/answer_Update.do",tparam,null,null,saveSuss);
}
...
<div style="margin-left:0%">
	...
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "answerInsert" onclick = "answerUpdate()">解决方案录入</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id = "answerUpdate" onclick = "answerUpdate()">解决方案修改</a>
</div>
</body>
</html>
