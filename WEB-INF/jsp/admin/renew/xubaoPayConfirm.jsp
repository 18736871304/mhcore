...
<body>
	<div style="margin-left:0%">
		...
		<table class = "common">
			<tr>
				...
				<td class = "report_common_4">
					<input class = "txt" id="policyno" name="policyno" onchange="checkpolicyno()" notnull = "续保保单号">
				</td>
		...
		<br>
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "xbpayConfirm" onclick = "xbpayConfirm()">实收确认</a>
	</div>
</body>
