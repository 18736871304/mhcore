...
function aftercodeselect(comboxid)
{
	...
	else if(comboxid.attr("id")=="qinsorgancode")
	{
		...
		var tturl1 = "policy/getAllRiskListin.do";
...
function renewquery()
{
	...
	tParam.cStartDate = $('#qcvalidateStart').datebox("getValue");
	tParam.cEndDate = $('#qcvalidateEnd').datebox("getValue");
...
<div style="margin-left:0%">
	<table class = "common">
		...
		<tr>
			...
			<td class = "common">
				<input class="easyui-datebox" style="width: 160%" id="qcvalidateStart" name="qcvalidateStart" notnull = "生效起期">
			</td>
			<td class = "title">
				生效止期
			</td>
			<td class = "common">
				<input class="easyui-datebox" style="width: 160%" id="qcvalidateEnd" name="qcvalidateEnd" notnull = "生效止期">
				<!-- (算头不算尾) -->
			</td>
	...
	<table id="renewList" class="easyui-datagrid" title="保单信息" style="width:auto;height:auto"
		...
		<thead>
			<tr>
				<th data-options="field:'cvalidate',width:90">生效月</th>
				<th data-options="field:'policyyear',width:90">保单年度</th>
