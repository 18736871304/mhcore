	...
	<script>
		...
		function disInsured(row) {
			...
			if (row.queryinsured == 'Y') {
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人证件到期日期</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人国籍</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人身高</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人体重</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人婚否</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人职业</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人年收入</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否有医保</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否吸烟</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人电子邮箱</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + row.insbirthday + '"></td></tr>';
		...
		function dealInsuredList(data) {
			...
			for (var i = 0; i < data.insuredList.length; i++) {
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人证件到期日期</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人国籍</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人身高</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人体重</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人婚否</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人职业</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人年收入</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否有医保</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否吸烟</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人电子邮箱</td><td class = "common"><input class = "txt" readonly name="dlginsbirthday" id="dlginsbirthday" value = "' + getQueryData(data.insuredList[i].insbirthday) + '"></td></tr>';
