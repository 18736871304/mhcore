...
<head>
	...
	<script>
		window.onload = function () {
			...
			$('#policyList').datagrid('showColumn', 'fentan_username');
			$('#policyList').datagrid('showColumn', 'shanxi_licai_type');
...
<body>
	<div style="margin-left:0%">
		...
		<%@ include file="/WEB-INF/common/query/policy/policyCommonQuery_shanxi.jsp"%>
		<br>
		...
		<br>
		<table class="common" style="width: 60%;">
			<tr>
				<td class="title">
					长期险单数合计
				</td>
