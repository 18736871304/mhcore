...
<div style="margin-left:0%">
	...
	<table class = "common">
		...
		<tr>
			...
			<td class = "common">
				<input class = "txt"   name = 'username'  id = 'username'  readonly value = '<%=oprVo.getIamsOprName()%>'>
				<input type = 'hidden' name = "reuserid"  id = "reuserid"  notnull = "出单员" value = '<%=oprVo.getIamsOpr()%>' class = "txt">
				<input type = 'hidden' name = 'resuerkey' id = 'resuerkey' value = '<%=oprVo.getUserid()%>'>
			</td>
