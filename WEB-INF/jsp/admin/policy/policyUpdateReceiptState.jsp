...
window.onload = function()
{
	...
	disComBox($('#receiptstate'),"receiptstate",null);
...
function policyUpdateState()
{
	...
	ajaxdeal("policy/updateReceiptState.do",tparam,null,null,saveSuss);
}
	...
	<table class = "common">
		<tr>
			...
			<td class = "common" style="width: 12%;">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="receiptstate" id="receiptstate" notnull = "回访状态">
				</select>
			</td>
			<td></td><td></td>
			<td></td><td></td>
