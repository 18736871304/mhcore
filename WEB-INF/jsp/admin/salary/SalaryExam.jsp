...
function salaryExam(state)
{
	...
	ajaxdeal("salary/agentCommStateUpdate.do",tparam,null,null,saveSuss);
}
	...
	<table id="salaryList" class="easyui-datagrid" title="员工薪资查询" style="width:auto;height:auto"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'statename',width:90">薪资状态</th>
				<th data-options="field:'sumsalary',width:90">合计</th>
			</tr>
		</thead>
	</table>
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "salaryExam" onclick = "salaryExam('02')">薪资审核</a>
</div>
</body>
</html>