		...
		<head>
			...
			<script>
				...
				function jiaquanfyp(val, row, index) {
					console.log(row.changxian_sumfyp20, row.ylprem)
				...
				<table id="policyList" class="easyui-datagrid" title="首期薪资查询" style="width:auto;height:auto"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'positionname',width:80">职岗</th>
							<th data-options="field:'entrydate',width:80">下团队日期</th>


							<th data-options="field:'sumfyp20',width:100">标保</th>
							<th data-options="field:'aaa1111',width:100,formatter:jiaquanfyp">加权标保</th>
							<th data-options="field:'changxian_sumfyp20',width:120">长标</th>
							<th data-options="field:'aa5',width:120">长年标</th>
							<th data-options="field:'aa4',width:120">长月标</th>
							<th data-options="field:'coefficient_changxian_sumfyp20',width:120">折长标</th>
							<th data-options="field:'coefficient_sumnianfyp20',width:120">折长年标</th>
							<th data-options="field:'coefficient_sumyuefyp20',width:120">折长月标</th>
							<th data-options="field:'ylprem',width:120">医保费</th>
							<th data-options="field:'jixiao',width:100">绩效</th>
							<th data-options="field:'aa3',width:140">长年提成</th>
							<th data-options="field:'aa2',width:140">长月提成</th>
							<th data-options="field:'aa1',width:140">医提成</th>
							<th data-options="field:'pushaward',width:160">宣传推动奖励</th>
							<th data-options="field:'buxianshi',width:140">限时奖励</th>
							...
							<!-- 
							<th data-options="field:'policycount',width:40">单数</th>
							<th data-options="field:'sumfyp20',width:70">标保</th>
							<th data-options="field:'sumnianfyp20',width:70">年缴标保</th>
							<th data-options="field:'sumyuefyp20',width:70">月缴标保</th>

							<th data-options="field:'coefficientsumfyp20',width:70">折算系数后标保</th>
							<th data-options="field:'coefficient_sumnianfyp20',width:70">折算后年缴标保</th>
							<th data-options="field:'coefficient_sumyuefyp20',width:70">折算后月缴标保</th>

							<th data-options="field:'ylprem',width:70">医疗险保费</th>
							<th data-options="field:'jixiao',width:70">绩效</th>
							<th data-options="field:'nianfypticheng',width:70">年缴提成</th>
							<th data-options="field:'yuefypticheng',width:70">月缴提成</th>
							<th data-options="field:'yiliaoticheng',width:70">医疗险提成</th>
							<th data-options="field:'pushaward',width:70">宣传推动奖励</th>
