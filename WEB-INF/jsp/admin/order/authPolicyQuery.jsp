		...
		<head>
			...
			<script>
				...
				function dis_authlink(val, row, index) {
					if (row.authstate == '02') {
						// return row.authlink;
						return '<a href="#" onclick="openPayurl(' + index + ')">复制</a>';
					}
				}
				...
				<table id="orderPolicyList" class="easyui-datagrid" title="认证信息" style="width:auto;height:auto"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'errormsg',width:160">异常信息</th>
							...
							<th data-options="field:'payFee',width:80">保费</th>
