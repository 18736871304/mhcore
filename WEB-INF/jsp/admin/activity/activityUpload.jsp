	...
	<%@ include file="/WEB-INF/common/include.jsp" %>
		...
		<head>
			...
			<script>
				...
				function checkbox() {
					var Selected = document.getElementById("updatetosea").checked
					console.log(Selected)
					if (Selected == true) {
						$('.iscrm').css("visibility","visible")				
					} else {
						$('.iscrm').css("visibility","hidden")
					}
				}
			...
			<div style="margin-left:0%">
				...
				<table class="common">
					<tr>
						...
						<td class="report_common_4">
							<select class="easyui-combobox" style="width:90%" panelHeight="auto" name="channel"
								id="channel" notnull="渠道类型">
							</select>
						</td>
						...
						<td class="report_common_4" style="width: 4%;">
							<input type="checkbox" id='updatetosea' onchange="checkbox()"
								style="zoom: 160%;margin: 0 4px;">
						</td>

						<td class="reprot_title_4 iscrm">
							CRM系统
						</td>
						<td class="report_common_4 iscrm">
							<select class="easyui-combobox" style="width:160%" panelHeight="auto" name="organcode"
								id="organcode">
							</select>
						</td>
				...
				<br>
				<font color="red">新资源上传时间必须自线索产生时间7天以内，公海资源上传时间必须自线索产生时间7天以外
				</font>
			</div>
		</body>
