...
<tr>
	...
	<td class = "reprot_common">
		<select class = "easyui-combobox" style="width:90%" panelHeight="auto" name="q03team" id="q03team" data-options="multiple:true">
		</select>
	</td>
</tr>
<!-- <tr>
	...
	<td class="reprot_common">
		<select class="easyui-combobox" style="width:90%" panelHeight="auto" name="q02team" id="q02team"
			data-options="multiple:true">
		</select>
	</td>
	...
	<td class="reprot_common">
		<select class="easyui-combobox" style="width:90%" panelHeight="auto" name="q03team" id="q03team"
			data-options="multiple:true">
		</select>
	</td>
</tr> -->