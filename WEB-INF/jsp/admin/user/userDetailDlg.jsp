...
{	
	...
	$('#dlg_rgtprovince').val(rowdata.rgtprovincename);
	$('#dlg_rgtcity').val(rowdata.rgtcityname);
	$('#dlg_rgtcountry').val(rowdata.rgtcountryname);
...
<div id="userDetailDlg" class="easyui-dialog" title="人员详细信息查询" 
		style="width:700px;height:600px;padding:10px;top:10px" 
		...
		<table style="width: 100%;">
			...
			<tr>
	 		...
	 		<tr>
	 			...
	 			<td class = "common">
	 				<input class = "txt" readonly name="dlg_rgtprovince" id="dlg_rgtprovince">
	 			</td>
	 		</tr>
	 		...
	 		<tr>
	 			...
	 			<td class = "common">
	 				<input class = "txt" readonly name="dlg_rgtcity" id="dlg_rgtcity">
	 			</td>
	 		</tr>
	 		...
	 		<tr>
	 			...
	 			<td class = "common">
	 				<input class = "txt" readonly name="dlg_rgtcountry" id="dlg_rgtcountry">
	 			</td>
	 		</tr>
