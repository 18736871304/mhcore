...
<body>
  ...
  <div style="margin-left:0%">
    ...
    <font color="red">1. 入职审批后，密码通过短信发送到员工手机上
      <br>2. 每月1号14:00以前操作离职申请，14:00以后操作入职申请
    </font>
    ...
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id="useredit" onclick="useredit()">修改</a>
  ...
  <div class="upload-box-uw dis_emali_uw">
    ...
    <input type="file" name="myfiles" class="upload-file-uw" id="filename" size="28"
  ...
  <div id="pdfDig" class="easyui-dialog" title="预览视图" style="width:820px;height:750px;padding:10px"
