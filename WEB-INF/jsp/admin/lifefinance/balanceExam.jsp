...
function balanceExam()
{
	...
	ajaxdeal("lifefinance/balanceupdate.do",tparam,null,null,saveSuss);
}
...
<div style="margin-left:0%">
	...
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "balanceExam" onclick = "balanceExam()">协议审核</a>
