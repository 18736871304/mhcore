	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/anlian/yly/bhlt_01.png?v=20181107_01"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anlian/yly/bhlt_02.png?v=20181107_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anlian/yly/bhlt_03.png?v=20181107_01" alt="">
				</div>
				<div id="nav6" class="product_desc">
					<img src="../../images/anlian/yly/bhlt_06.png?v=20181107_01" alt="">
					<a href="../../images/anlian/yly/bzsy.png?v=20181107_01" class="dingwei"></a>
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anlian/yly/bhlt_04.png?v=20181107_02" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anlian/yly/tbxz.pdf"></a>
						<a href="../../contract/anlian/yly/yly_bxtk.pdf"></a>
						<a href="../../images/anlian/yly/xxpl.png?v=20181107_01"></a> 
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anlian/yly/bhlt_05.png?v=20181107_01" alt="">
				</div>
			</div>
		</div>
	</div>
