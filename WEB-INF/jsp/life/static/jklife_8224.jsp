...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/jklife/8224/8224_01.png?v=2"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/jklife/8224/8224_02.pv=2v=2" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/jklife/8224/8224_03.png?v=2" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/jklife/8224/8224_04.png?v=2" alt="">
					
					<div class="recommend_wrapper">
						<a href="../../contract/jklife/8224/8224_tb.pdf"></a>
						<a href="../../contract/jklife/8224/8224_tk.pdf"></a>
					</div>
					
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/jklife/8224/8224_05.png?v=2" alt="">
				</div>
			</div>
			
			<div class="pl bgColor fixedBox w100 hq-productBottom" style="display:none">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >5000.00</span><span>元/年起</span>
				            <input type="hidden" value = '5000.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'8224','jklife');
	   })
