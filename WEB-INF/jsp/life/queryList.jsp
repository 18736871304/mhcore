...
/* navbar bg color and bottom edge*/
  ...
  a:hover {color:white;} a:visited {color:white;} a:link {color:white;} a {color:white;}
...
<!--main page-->
    <div class="header">
    	<p>我的订单</p>
    	<p style="float:right;"><a style="text-decoration: none;" href = '../../user/logout.do'>退出</a></p>
    </div>
...
{
	if("L11158"==riskcode || "L16036"==riskcode){
		window.location.href = "../../life/common/abzQueryDetail.do?orderNo="+orderid+"&insorgancode="+insorgancode;
	}else{
