...
<head>
    ...
    <link rel="stylesheet" href="/css/insureplan/family_index.css?v=20191201_02">
</head>
<script src="/js/common/lcl/lib/jquery1.12.4.min.js"></script>
<script src="/js/common/lcl/common.js"></script>
<script src="/js/insureplan/index.js?v=20200408_03"></script>
...
{
	window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx37a5a6ceced4f359&redirect_uri=http://insure.meihualife.com/weixin/bindWxUser.do&response_type=code&scope=snsapi_userinfo&state=familyplan_"+tans_planid+"#wechat_redirect";
}
else
{
		var jsstr = ${jsstr};
...
<input style="display:none" id="plantype" value="02">
