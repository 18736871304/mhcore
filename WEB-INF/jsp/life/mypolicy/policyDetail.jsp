	...
	<div class="main d_footback policyDetailBox">
		...
		<div class="policyHolderBox d_boxSz d_mb15">
			...
			<div class="box d_boxSz fuwuBox">
				...
				<!-- <a href="">下载</a> -->
				 <div id="depart" style="width: 25%;">
					<div class="fuwuList" id="clservice"  style="width: 100%;">
...
<script>
	...
	const contno = urlParams.get('contno');
	...
	httpRequest('/rights/getServiceCom.do', 'get', '', {
		success: function (res) {
			...
			// 	var avtar = $('#serviceImg').attr("src")
			// 	var avtarName = $('#serviceName').text().slice(5)
			// 	messageAlert('https://insure.meihualife.com//images/mypolicy/policytrust/kefu.png', avtar,
			// 		avtarName);
			// }
		}
	})
	...
	$('#openPolicyurl').on('click', function () {
		...
		var ludan = orderid.substring(0, 2)
