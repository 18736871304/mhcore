...
<head>
	...
	<style>
		.header {
			background: url("/images/mypolicy/members/zhongjilvtong-hbg.jpg") no-repeat center;
...
<!--	<div class="list-box" id="listBox"></div>-->
	<div class="ig-content">
		<img src="/images/mypolicy/members/zhongjilvtong/zhongjilvtong_1.jpg">
	</div>
	<div class="contact-button"><button id="contactBtn" onclick = "connect_us('zl')">立即联系</button></div>
</div>
