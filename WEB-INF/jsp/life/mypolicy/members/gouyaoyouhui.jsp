...
<head>
    ...
    <style>
        .header {
            background: url("/images/mypolicy/members/jiuyilvtong-hbg.jpg") no-repeat center;
...
<div class="main">
    ...
    <div class="content">
        <div class="empty-box">
            <div class="empty-img"><img src="/images/mypolicy/members/jingqingqidai.png"></div>
        </div>
    </div>
    <!-- 
    <div class="contact-button"><button id="contactBtn" onclick = "connect_us('gy')">立即联系</button></div>
     -->
</div>
