...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/abzong/cqs/cqs_01.png?v=20180419_01"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/abzong/cqs/cqs_02.png?v=20180419_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/abzong/cqs/cqs_03.png?v=20180419_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/abzong/cqs/cqs_04.png?v=20180419_01" alt="">
					<div class="recommend_wrapper" style="padding: 0 0 0.7rem 0;">
						<a href="../../contract/abz/common/ab-lpxz.pdf"></a>
						<a href="../../contract/abz/cqs/ab-cqs.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/abzong/cqs/cqs_05.png?v=20180419_01" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
						<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
						    ...
						    <span readonly="" class="insurePrice" id="insurePrice" >74.70</span><span>元/年起</span>
				            <input type="hidden" value = "74.70" id = "insurePrice_trans">
			            </dt>
    ...
    */
	...
	function showprem()
	{
		...
		sendPriceRequest("../../life/abz/getprice02.do",premdata,function (data) 
		{
    ...
    $('.footer_go').click(function()
    {
    	...
    	else
    	{
			...
			//alert($("#show_amnt").attr("data-id"));
			if($("#show_amnt").attr("data-id")!='null')
			{
				amnt = $("#show_amnt").attr("data-id");
			}
			
			//alert($('#insurePrice_trans').val());
			if($('#insurePrice_trans').val()!=null&&$('#insurePrice_trans').val()!="")
			{
				prem = $('#insurePrice_trans').val();
			}
    		
    		window.location.href = "../../life/abz/toldinfo.do?riskCode=L11158&payendyear="+payendyear+"&amnt="+amnt+"&prem="+prem;	
    	}
	});
	</script>
	<script>
	...
	wx.ready(function () {	//朋友圈
    	wx.onMenuShareTimeline({
	        title: '长青树重大疾病险', // 分享标题
	        link: 'http://insure.meihualife.com/life/abz/dis_cqs.do?reuserid='+reuserid, // 分享链接
	        imgUrl: 'http://insure.meihualife.com/images/abzong/cqs/cqs-wx.png',
	    ...
	    wx.onMenuShareAppMessage({
	        title: '长青树重大疾病险', // 分享标题
	        desc: '身故全残疾病终末期全面保，轻症额外赔付5次，享豁免', // 分享描述
	        link: 'http://insure.meihualife.com/life/abz/dis_cqs.do?reuserid='+reuserid, // 分享链接
	        imgUrl: 'http://insure.meihualife.com/images/abzong/cqs/cqs-wx.png',
