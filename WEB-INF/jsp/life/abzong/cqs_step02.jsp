...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/abzong/insuranceInformation.js?v=20180507_01"></script>
...
<body style="">
    <header class="header w100 pl bgColor">
        <span>长青树重大疾病险</span>
       	<br />
        <span>本产品由安邦人寿保险股份有限公司承保</span>
        <img src="../../images/logo/anbang_typein.png" />
    </header>
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="cqs">
            <input type="text" style="display:none" class="personInfo" id="insOrganCode" value="anbangz">
...
<%--        <input type="text" style="display:none" class="personInfo" id="hmPrice" value="${hmPrice}"> --%> 
           <input type="text" style="display:none" class="personInfo" id="oldorderNo" value="">
			<!--产品投保要素信息-->
...
<!--被保人信息-->
            <section class="infoList" id="scrollTop">
	            <p class="ml">被保人信息</p>
	            <div class="infoSec pl pr bgColor borTop1 borBot1">
                    <dl class="clearfix infoDl borBot1 dlSec bottom-1">
...
<!--不一致时被保人信息-->
                    <div class="insured" style="display: none;">
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec">
                            ...
                            <dd class="w65 l-float txtR hasArrow">
                                <input type="text" style="display:none" name="" id="" value="3"> 
                                <input type="text" style="display:none" class="personInfo" name="insuredList[0].insuredProvince" id = "insuredProvince" value="">
                                <input type="text" style="display:none" class="personInfo" name="insuredList[0].insuredCity" id = "insuredCity" value=""> 
                                <input type="text" style="display:none" class="personInfo" name="insuredList[0].insuredCounty" id = "insuredCounty" value=""> 
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec">
                     	...
                     	<dl class="clearfix infoDl borBot1 dlSec">
                            <dt class="w35 l-float">职业</dt>
                            <dd class="w65 l-float txtR hasArrow">
                                <input type="text" id="appntOccupation3" class="textfield txtR personInfo tmp occ bb" placeholder="请选择" readonly="" style="color: rgb(153, 153, 153);">
                                <input type="text" style="display:none" class="personInfo" id="occupationType" name="applicant.occupationtype" value="">
                                <i class="arrow"></i>
                            </dd>
                            <span class="errorMsg"></span>
                        </dl>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >本人已认真阅读并同意<br/>
		            <a href="<%=request.getContextPath()%>/contract/abz/cqs/notice.html">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/abz/cqs/pro_clause_01.html">《产品条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/abz/cqs/pro_clause_05.html">《人身投保提示书》</a><br/>
		            <a href="<%=request.getContextPath()%>/contract/abz/sel/pro_clause_06.html">《投保提示》</a>
		            <a href="<%=request.getContextPath()%>/contract/abz/cqs/pro_clause_06.html">《费率表》</a>
