...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/zhongan/insuranceInformation.js?v=2180517_01"></script>
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
        	<input type="hidden" class="personInfo" id="productNo" value="zhongan_zhyw">
            ...
            <section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span>我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/zhongan/zhyw/zhyw04.pdf">《个人意外伤害保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/zhyw/zhyw01.pdf">《附加意外伤害救护车费用保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/zhyw/zhyw02.pdf">《附加意外伤害医疗费用保险条款（b款）》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/zhyw/zhyw03.pdf">《附加意外伤害住院津贴保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/zhyw/zhyw05.pdf">《营运交通工具乘客意外伤害保险》</a>
