...
<head>
    ...
    <script src=" ../../js/zhongan/insuranceInformation.js?v=2180511_08"></script>
    <style type="text/css">
    	#nav1,#nav2,#nav3,#nav4{
    	padding: 0;
    	}
...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/zhongan/jtyw3/jtyw3_01.png?v=20180513_01"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/zhongan/jtyw3/jtyw3_02.png?v=20180612_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/zhongan/jtyw3/jtyw3_03.png?v=20180522_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/zhongan/jtyw3/jtyw3_04.png?v=20180513_01" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/zhongan/jtyw3/jtyw3_05.png?v=20180513_01" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
						<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
						    ...
						    <span readonly="" class="insurePrice" id="insurePrice" >365.00</span><span>元/年起</span>
						    <input type="hidden" value = "365.00" id = "insurePrice_trans">
			            </dt>
    ...
    {	
    	...
    	else
    	{
    		...
    		window.location.href = "./jtyw3_02.do?insplan="+insplan+"&isextend="+isextend;
    	}
	});
    ...
    function showprem()
    {
		...
		var prem = ywpriceCanShu("zhongan_jtyw3",insplan,isextend);
