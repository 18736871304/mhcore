...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
        	<input type="hidden" class="personInfo" id="productNo" value="zhongan_jtyw4">
            ...
            <section class="infoList" id="scrollTop">
	            ...
	            <div class="infoSec pl pr bgColor borTop1 borBot1">
	            		<dl class="clearfix infoDl borTop1 dlSec">
                            <dt class="w35 l-float">投被保人关系</dt>
                            <dd class="w65 l-float txtR hasArrow">
                                <select id="relation04" name="" class="cardType txtR personInfo getPrice dw-hsel" tabindex="-1">
                                    <option value="01">父母</option>
                                    <option value="02">配偶</option>
                                    <option value="03">子女</option>
                                </select> 
                        ...
                        <dl class="clearfix infoDl borTop1 dlSec">
                            <dt class="w35 l-float">姓名</dt>
                            <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                                <input type="text" class="textfield txtR personInfo" id="insuredName04" value="" placeholder="请输入被保人姓名">
                            </dd>
                                <span class="errorMsg"></span>
                        </dl>
                        <dl class="clearfix infoDl borTop1 dlSec">
                            <dt class="w35 l-float">证件类型</dt>
                            <dd class="w65 l-float txtR hasArrow">
                                <select id="insuredCardType04" class="cardType txtR personInfo dw-hsel" tabindex="-1">
                                    <option value="0">身份证</option>
                                </select>
                                <i class="arrow"></i> 
                            </dd>
                        ...
                        <dl class="clearfix infoDl borTop1 dlSec">
                            <dt class="w35 l-float">证件号码</dt>
                            <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                                <input type="text" class="textfield txtR personInfo idNo_compare" id="insuredIdNo04" value="" placeholder="请输入证件号码">
                            </dd>
                                <span class="errorMsg"></span>
                        </dl>
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec" style="display: none;">
	                        <dt class="w35 l-float">出生日期</dt>
	                        <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                                <input type="text" class="textfield txtR personInfo" id="insuredBirthday04" readonly value="" placeholder="请输入出生日期">
                            </dd>
	                        <span class="errorMsg"></span>
	                    </dl>
	                    <dl class="clearfix infoDl borBot1 dlSec" style="display: none;">
	                        <dt class="w35 l-float">性别</dt>
	                        <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                                <input type="text" class="textfield txtR personInfo" id="insuredSex04" readonly value="" placeholder="请输入性别">
                            </dd>
	                        <span class="errorMsg"></span>
	                    </dl>
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec">
                            <dt class="w35 l-float">手机号</dt>
                            <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                                <input type="tel" class="textfield txtR personInfo" id="insuredMobile04" value="" placeholder="请输入手机号码">
                            </dd>
                            <span class="errorMsg"></span>
                        </dl>
                   	...
                   	<dl class="clearfix borBot1 dlSec">
				        <dt class="w35 l-float">职业大类</dt>
	                	<dd class="w65 l-float txtR hasArrow">
	                		<select id="onelevel04" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
	                  	        <option value='机关'>机关</option>
								<option value='农副牧渔业'>农\副\牧\渔业</option>
								<option value='森林木材业'>森林木材业</option>
								<option value='地质矿产'>地质矿产</option>
			        ...
			        <dl class="clearfix borBot1 dlSec">
				        <dt class="w35 l-float">职业小类</dt>
	                	<dd class="w65 l-float txtR hasArrow">
	                		<select id="twolevel04" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
	                  	        <option value='机关团体公司行号'>机关团体公司行号</option>
	                        </select>
	                        <i class="arrow"></i>
	                    </dd>
			        ...
			        <dl class="clearfix borBot1 dlSec">
				        <dt class="w35 l-float">职业细类</dt>
	                	<dd class="w65 l-float txtR hasArrow">
	                		<select id="threelevel04" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
	                  	        <option value='0001001'>内勤人员</option>
	                        </select>
	                        <i class="arrow"></i>
	                    </dd>
