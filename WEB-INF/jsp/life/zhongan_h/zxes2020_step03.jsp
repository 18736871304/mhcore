...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>投保信息</title>
    <link rel="stylesheet" href="../../css/hezhong/infos.css?v=20200820_02">
    ...
    <script src=" ../../js/zhongan_h/insuranceInformation.js?v=20200826_02"></script>
        ...
        <form id="formId" name="formName" method="post">
        	...
        	<p class="ml">产品投保要素</p>
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	<dl class="clearfix borBot1 dlSec">
				        ...
				        <dd class="w60 l-float txtR pr">
					        <input type="text" class="textfield txtR personInfo" id="product_plan" value="尊享e生2020版">
						</dd>
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        ...
			        <dl class="clearfix infoDl borBot1 dlSec">
	                  ...
	                  <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
	                  	<input type="tel" class="textfield txtR personInfo" id="tel" value="" placeholder="用于接收投保信息">
	                  </dd>
	                  <span class="errorMsg"></span>
	                </dl>
	                ...
	                <dl class="clearfix infoDl borBot1 dlSec">
	                  ...
	                  <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
	                  	<input type="email" class="textfield txtR personInfo" id="email" value="" placeholder="用于接收电子保单">
	                  </dd>
	                  <span class="errorMsg"></span>
	                </dl>
			    </div>
            ...
            <section class="infoList" id="scrollTop">
	            ...
	            <div class="infoSec pl pr bgColor borTop1 borBot1">
		            ...
		            <div class="insured" style="display:'';">
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec" id="ins_birthday" style="display: none;">
	                        <dt class="w35 l-float">出生日期</dt>
	                        <dd class="w65 l-float txtR hasArrow">
	                    ...
	                    <dl class="clearfix infoDl borBot1 dlSec" id="ins_sex" style="display: none;">
		            ...
		            <dl class="clearfix infoDl borTop1 dlSec">
				       	...
				       	<dd class="w40 l-float txtR pr hasArrow">
				        	<select id="socialinsuflag" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
		            ...
		            <dl class="clearfix infoDl borTop1 dlSec">
				       	...
				       	<dd class="w40 l-float txtR pr hasArrow">
				        	<select id="issmoke" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
				            	<option value="N">无</option>
				            	<option value="Y">有</option>
							</select>
				            <i class="arrow"></i> 
		            ...
		            <dl class="clearfix infoDl borTop1 dlSec">
				       	...
				       	<dd class="w40 l-float txtR pr hasArrow">
				        	<select id="zdjb" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
				    ...
				    <dl class="clearfix infoDl borTop1 dlSec">
					   	...
					   	<dd class="w40 l-float txtR pr hasArrow">
					       	<select id="zjzyjt" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
					          	<option value="Y">投保</option>
				                <option value="N">不投保</option>
					        </select>
					        <i class="arrow"></i> 
					 ...
					 <dl class="clearfix infoDl borTop1 dlSec">
					 	...
					 	<dd class="w40 l-float txtR pr hasArrow">
					 		<select id="txyl" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
					        	<option value="Y">投保</option>
				                <option value="N">不投保</option>
					        </select>
					     	<i class="arrow"></i> 
					 ...
					 <dl class="clearfix infoDl borTop1 dlSec">
					 	...
					 	<dd class="w40 l-float txtR pr hasArrow">
					    	<select id="hwyl" class="cardType txtR personInfo dw-hsel insured_change" tabindex="-1">
					        	<option value="Y">投保</option>
				                <option value="N">不投保</option>
					         </select>
					         <i class="arrow"></i> 
            ...
            <section class="infoList">
		        <div class="ml whetherRead">
		            <i id="whetherCheck" class="unCheckBox"></i>
		            <span>我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/tbxz.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/zx_zyyl.pdf">《个人住院医疗保险条款(2020版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/zx_exzlhw.pdf.pdf">《个人恶性肿瘤海外医疗保险条款(2020版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_zjzyjt.pdf">《附加重大疾病住院津贴保险条款(2020版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_zdjb.pdf">《附加重大疾病保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_zdjb_sskz_txyl.pdf">《附加指定疾病及手术扩展特需医疗保险条款(2020版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_hm.pdf">《附加免赔额豁免保险条款(2020版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_exzl_zzlz.pdf">《附加恶性肿瘤质子重离子医疗保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/fj_exzl_tdyp.pdf">《附加恶性肿瘤院外特定药品费用医疗保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/yszc.pdf">《个人信息保护政策》</a>
		            <a href="<%=request.getContextPath()%>/contract/zhongan/AM98/flb.pdf">《费率表》</a>
		            </span>
		        </div>
		    </section>
        ...
        <div class="pl bgColor fixedBox w100">
            <dl class="clearfix infoDl w100">
				<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				    ...
				    <span readonly="" class="insurePrice" id="insurePrice" >136.00</span><span id = "priceunit">元</span>
	            </dt>
