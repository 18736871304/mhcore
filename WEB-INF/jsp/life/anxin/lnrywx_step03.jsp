...
<body style="">
    ...
    <article class="info">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="060001_lnrywx">
			    ...
			    <dl class="clearfix borBot1 dlSec" >
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "amnt" class="premium txtR iFactor getPrice dw-hsel getAmntDesc" tabindex="-1" >
								<option value="333000">30万元</option>
								<option value="222000">20万元</option>
								<option value="111000">10万元</option>
								<option value="56000">5万元</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			            <span class="errorMsg"></span>
			   ...
			   <!--  <div id="plan1amnt"> -->
			    <dl class="clearfix infoDl borBot1 dlSec" >
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo" id = "bz_amnt" type="text" value = "30万元" readonly="">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
		     	<dl class="clearfix borBot1 dlSec" >
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo" id = "sgsc_amnt" type="text" value = "30万元" readonly="readonly">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
		        <dl class="clearfix borBot1 dlSec" >
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo" id = "ywyl_amnt" type="text" value = "3万元" readonly="readonly">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
		        <dl class="clearfix borBot1 dlSec" >
			        <dt class="w35 l-float">救护车费用</dt>
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo" id = "jhc_amnt" type="text" value = "3000元" readonly="readonly">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
		        </div>
 ...
 <!--受益人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/insurancePolicy.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/insuranceClauses.pdf">《人身意外伤害保险条款（2016版）》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/jiuhu_insuranceClauses.pdf">《意外伤害保险附加救护车费用保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/ylfy_insuranceClauses.pdf">《意外伤害保险附加意外伤害医疗费用保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/declarationsConfirm.pdf">《投保声明》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/lnrywx/gaozhi.pdf">《违反如实告知》</a>
