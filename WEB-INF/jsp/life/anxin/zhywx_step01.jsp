		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anxin/zhywx/zhywx_02.png?v=1" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/zhywx/zhywx_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/zhywx/zhywx_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anxin/axys/lipeiliucheng.pdf"></a>
						<a href="../../contract/anxin/zhywx/insuranceClauses.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anxin/zhywx/zhywx_05.png" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >340.00</span><span>元/年起</span>
				            <input type="hidden" value = '340.00' id = 'insurePrice_trans'>
		            	</dt>
		...
		function showprem()
		{
		  ...
		  if($("#showDate").attr("data-year")!='null')
			...
			*/
			...
			$('#insurePrice').html(Number("340").toFixed(2));
	   		$('#prem').val("340");
			$('#insurePrice_trans').val(Number("340").toFixed(2));
			
			var premdata = 
			{
				"productNo":'060001_zhywx',
			};
...
//			   	console.log(obj);
	    ...
	    function formatYear (nowYear) {
	        var arr = [];
	        for (var i = nowYear; i >= nowYear-66; i--) {
	            arr.push({
	                id: i + '',
	                value: i + ''
	            });
	...
	<script>
        ...
        {	
        	...
        	{ 
    			...
    			window.location.href = "../../life/anxin/nc_ax_zhywx.do?prem="+prem
        		}
		});
	</script>
	<script>
