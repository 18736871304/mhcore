...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/anxin/insuranceInformation.js?v=20180706"></script>
  ...
  /*   /* var productCode = '${productCode}';
    ...
    var socialInsuFlag = '${socialInsuFlag}';
        $(function () {
        	...
        	{
        		$("#plan").val(aliascode);
        		$("#plan_dummy").val($("#plan").find("option:selected").text());
        	}
        	calPrice();
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="aliasname" value="qnbbwylx">
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="07P002_qnbbwylx">
...
<%--             <input type="text" style="display:none" class="personInfo" id="aliascode" value="${aliascode}">--%>
            ...
            <section class="infoList">
                ...
                <dl class="clearfix borBot1 dlSec">
				        <dt class="w35 l-float">保险套餐</dt>
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "plan" class="premium txtR iFactor getPrice dw-hsel personInfo" tabindex="-1">
								<option value="07H014">计划一</option>
								<option value="07H015">计划二</option>
								<option value="07H016">计划三</option>
								<option value="07H017">计划四</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			    ...
			    <dl class="clearfix borBot1 dlSec"  style="display: none;">
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input id = "amnt" type="text" value = "5000000">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
 ...
 <!--受益人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意:<br/>
		            	计划一、计划三
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/aizhengjitiaokuan1.pdf">《癌症疾病保险条款（2017版）》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/zhuyuantiaokuan1.pdf">《住院综合医疗保险条款（2017版）》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/fujiatiaokuan1.pdf">《附加住院生活津贴保险条款(2017版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/insurancePolicy1.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/declarationsConfirm1.pdf">《投保声明》</a>
		            ...
		            <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/anxin_customerNotification.pdf">《客户告知书》</a>
		            	计划二、计划四
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/zhuyuantiaokuan2.pdf">《住院综合医疗保险条款（2017版）》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/zhongdajitiaokuan.pdf">《重大疾病保险条款（2017版）》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/fujiatiaokuan2.pdf">《附加住院生活津贴保险条款(2017版)》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/insurancePolicy2.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/qnbbwylx/declarationsConfirm2.pdf">《投保声明》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys/lipeiliucheng.pdf">《理赔流程》</a>
		            <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/anxin_customerNotification.pdf">《客户告知书》</a>
		            </span>
		        </div>
