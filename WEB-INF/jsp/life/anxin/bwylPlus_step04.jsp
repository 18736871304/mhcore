            	...
            	<dl class="clearfix borBot1 dlSec" style="display: none;">
		     	...
		     	<dl class="clearfix borBot1 dlSec"  style="display: none;">
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input id = "amnt" type="text" value = "1000000">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
           ...
           <%--  <section class="infoList  renewalSec" style="display: none;">
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/anxin/bwylPlus/insurancePolicy.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/bwylPlus/insuranceClauses.pdf">《保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/bwylPlus/declarationsConfirm.pdf">《投保声明》</a>
