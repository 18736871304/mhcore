	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/anxin/axes2/anes2bwylx_01.png?v=20180531"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anxin/axes2/anes2bwylx_02.png?v=20180531" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/axes2/anes2bwylx_03.png?v=20180531" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/axes2/anes2bwylx_04.png?v=20180531" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anxin/axys/lipeiliucheng.pdf"></a>
						<a href="../../contract/anxin/axys2/insuranceClausesA.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anxin/axes2/anes2bwylx_05.png?v=20180531" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >99.00</span><span>元/年起</span>
				            <input type="hidden" value = '99.00' id = 'insurePrice_trans'>
		            	</dt>
	...
	<script>
        ...
        {	
        	...
        	{ 
        		...
        		window.location.href = "./toldinfo.do?aliasname=axes2&prem="+prem+"&socialInsuFlag"+socialInsuFlag;
        		}
		});
	</script>
	<script>
