	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/anxin/qnbbwylx/qnbbwylx_01.png?v=20180531"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-60周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">1年</span></p>
					<p><span class="left">最高保额</span><span class="right">500万</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anxin/qnbbwylx/qnbbwylx_02.png?v=20180531" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/qnbbwylx/qnbbwylx_03.png?v=20180531" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/qnbbwylx/qnbbwylx_04.png?v=20180531" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anxin/axys/lipeiliucheng.pdf"></a>
						<a href="../../contract/anxin/qnbbwylx/zhuyuantiaokuan2.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anxin/qnbbwylx/qnbbwylx_05.png?v=20180531" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                <dl class="clearfix infoDl borBot1 dlSec"  id = "select_plan">
		                	<dt class="w65 l-float">住院综合医疗保险套餐</dt>
		                	<dd class="w35 l-float txtR hasArrow">
		                        <span  id="show_plan" style="padding-right: 0.75rem;" data-id = 'null'>计划一</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >292.00</span><span>元/年起</span>
				            <input type="hidden" value = '292.00' id = 'insurePrice_trans'>
		            	</dt>
	...
	<script>
        ...
        {	
        	...
        	{ 
        		...
        		window.location.href = "./toldinfo.do?aliasname=qnbbwylx&socialInsuFlag="+socialInsuFlag+"&prem="+prem+"&plan="+plan;
        		}
		});
	</script>
	<script>
