...
<head>
    ...
    <script src=" ../../js/hezhong/insuranceInformation.js?v=20180606"></script>
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="636">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/hezhong/acx/acx_laxtiaokuan.pdf">《合众爱出行两全保险（2017）》条款</a>
		            <a href="<%=request.getContextPath()%>/contract/hezhong/acx/acx_xxpl.pdf">爱出行信息披露</a>
            ...
            <dl class="clearfix infoDl w100">
				<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
	            	...
	            	<%--<p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180402" alt="" style="width: 1.5rem;"></p>--%>
                        <p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180521" alt="" style="width: 1.5rem;"></p>
