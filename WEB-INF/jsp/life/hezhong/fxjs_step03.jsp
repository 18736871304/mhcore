...
<head>
    ...
    <title>投保信息</title>
    <link rel="stylesheet" href="../../css/hezhong/infos.css?v=20180514">
    ...
    <script src=" ../../js/hezhong/checkFn.js?v=20180711"></script>
    <script src=" ../../js/hezhong/insuranceInformation.js?v=20180711"></script>
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="256">
            <input type="text" style="display:none" class="personInfo" id="insOrganCode" value="hezhong">
            <input type="text" style="display:none" class="personInfo" id="toage" value="${age}">
            <input type="text" style="display:none" class="personInfo" id="tosex" value="${sex}">
            <input type="text" style="display:none" class="personInfo" id="riskCode" value="${riskCode}">
			<!--产品投保要素信息-->
					...
					<dl class="clearfix borBot1 dlSec">
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "insuyear" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
								<option value="1000Y">至105周岁</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			            <span class="errorMsg"></span>
 ...
 <!--投保人信息-->
            <section class="infoList">
                ...
                <dl class="clearfix infoDl borBot1 dlSec">
                    ...
                    <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                        <input type="number" class="textfield txtR personInfo" id="income" name="applicant.appntZipIncome" value="" placeholder="单位：万元">
                    </dd>
                    <span class="errorMsg"></span>
                </dl>
                <dl class="clearfix borBot1 dlSec">
                    ...
                    <dd class="w65 l-float txtR hasArrow">
                        <select id="onelevel" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
                            ...
                            <option value='木材森林业'>木材森林业</option>
                            <option value='地质矿产业'>地质矿产业</option>
                            <option value='交通运输业'>交通运输业</option>
                            <option value='建筑工程业'>建筑工程业</option>
                            <option value='制造业'>制造业</option>
                            <option value='传媒广告艺术影视业'>传媒\广告\艺术\影视业</option>
                            <option value='娱乐餐饮业'>娱乐\餐饮业</option>
                            <option value='科学文化教育卫生保健'>科学\文化\教育\卫生保健</option>
                            <option value='公共事业'>公共事业</option>
                            <option value='一般商业服务业'>一般商业\服务业</option>
                            <option value='治安人员'>治安人员</option>
                            <option value='军人'>军人</option>
                            <option value='职业运动'>职业运动</option>
                            <option value='其他'>其他</option>
                            <option value='无业'>无业</option>
                            <option value='计算机与互联网业'>计算机与互联网业</option>
                        </select>
                        <i class="arrow"></i>
                    </dd>
                    <span class="errorMsg"></span>
                ...
                <dl class="clearfix borBot1 dlSec">
                    ...
                    <dd class="w65 l-float txtR hasArrow">
                        <select id="threelevel" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
                            <option value='0101001'>农场经营者（不亲自作业）</option>
                        </select>
                        <i class="arrow"></i>
                    </dd>
                    <span class="errorMsg"></span>
...
<!--不一致时被保人信息-->
                    <div class="insured" style="display: none;">
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec">
                            <dt class="w35 l-float">税收身份类型</dt>
                            <dd class="w65 l-float txtR hasArrow">
                                <select id = "insuredss" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
                                    <option value="1">中国税收居民</option>
                                </select>
                                <i class="arrow"></i>
                            </dd>
                        ...
                        <dl class="clearfix infoDl dlSec">
                            <dt class="w35 l-float">国籍</dt>
                            <dd class="w65 l-float txtR hasArrow">
                                <select id = "insuredgj" class="cardType txtR personInfo  dw-hsel" tabindex="-1">
                                    <option value="156">中国</option>
                                </select>
                                <i class="arrow"></i>
                            </dd>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/hezhong/fxjs/fxjstk.pdf">《福享金生年金保险》条款</a>
		            <a href="<%=request.getContextPath()%>/contract/hezhong/fxjs/fxjsxxpl.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/hezhong/fxjs/fxjsfl.pdf">《福享金生年金保险费率表》</a>
		            <a href="<%=request.getContextPath()%>/contract/hezhong/fxjs/fxjstbtss.pdf">2017四季度《投保提示书》</a>
		            <a id="LifetimeOrRegularasis" href="<%=request.getContextPath()%>/contract/hengqin/taxResident.html" >《中国税收居民声明》</a>
                    <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/hezhong_customerNotification.pdf">《客户告知书》</a></span>
		        </div>
		    </section>
        </form>
        <!--投保按钮-->
            ...
            <dl class="clearfix infoDl w100">
				<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
	            	...
	            	<%--<p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180402" alt="" style="width: 1.5rem;"></p>--%>
                        <p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180523" alt="" style="width: 1.5rem;"></p>
