	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hezhong/fxjs/fxjsnjx_01.png?v=20180625"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">28天-70周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">至105周岁</span></p>
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hezhong/fxjs/fxjsnjx_02.png?v=20180420" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hezhong/fxjs/fxjsnjx_03.png?v=20180420" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hezhong/fxjs/fxjsnjx_04.png?v=20180420" alt="">
					<div class="recommend_wrapper">
						<a href="javascript:void(0)" ></a>
						<a href="../../contract/hezhong/fxjs/fxjstk.pdf"></a>
						<a href="../../contract/hezhong/fxjs/fxjsxxpl.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hezhong/fxjs/fxjsnjx_05.png?v=20180420" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_BXTime" style="padding-right: 0.75rem;" data-id = 'null'>至105周岁</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <input id = "prem" class="w65" type="number" style="padding-right: 0.75rem;width: 100%;"
		                        	onchange = "showprem();" placeholder="10000元起,1000的倍数递增" >
		                    </dd>
		                </dl>
						<dl class="clearfix infoDl dlSec"  id="select_prem">
		                	<dt class="w35 l-float">基本保额</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <input id = "amnt" class="w65" type="number" style="padding-right: 0.75rem;width: 100%;" readonly="readonly">
		                    </dd>
		                </dl>
	                </div>
	            </section>   
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
			            	<p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180528" alt="" style="width: 1.5rem;"></p>
				            <span readonly="" class="insurePrice" id="insurePrice" >1000.00</span><span>元/年起</span>
				            <input type="hidden" value = '1000.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script type="text/javascript">
		...
		function showprem()
		{
            ...
            if(prem==""||prem==null){
                ...
                if(!reg.test(prem/1000)){
                    alert("您输入的金额不符合要求！");
                    return;
                }else{
                    if(payendyear=='3Y'){
                        if(prem<5000){
                            alert("您输入的金额不能小于5000！");
                            return;
                        }
                    }else if(payendyear=='5Y'){
                        if(prem<2000){
                            alert("您输入的金额不能小于2000！");
                            return;
                        }
                    }else if(payendyear=='10Y'){
                        if(prem<1000){
                            alert("您输入的金额不能小于1000！");
                            return;
                        }
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=256&payendyear="+payendyear+"&insuyear="+insuyear
					+"&fxjs_prem="+prem+"&amnt="+amnt+"&age="+age+"&sex="+sex;
        	}	
		});
	</script>
	<script>
