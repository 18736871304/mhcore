...
<head>
	...
	<link rel="stylesheet" href="../../css/hengqin/index.css?v=180502">
	<link rel="stylesheet" href="../../css/hengqin/iosSelect.css?v=180502">
	<script src=" ../../js/hengqin/jquery-1.10.1.min.js?v=180502"></script>
	<script src="http://res.wx.qq.com/open/js/jweixin-1.2.0.js?v=180502"></script>
	<script src=" ../../js/hengqin/iscroll.js?v=180502" type="text/javascript"></script>
	<script src=" ../../js/hengqin/iosSelect_2.js?v=180502" type="text/javascript"></script>
	<script src=" ../../js/hengqin/areaData_v2.js?v=180502"></script>
	<script src=" ../../js/hengqin/zepto.js?v=180502"></script>
	<script src=" ../../js/hengqin/sjMain.js?v=180502"></script>
	<style>
		.recommend_wrapper{
			position: absolute;
			left: 0;
...
<div class="index_wrapper">
	<div class="main_wrapper">
		<div class="banner_wrapper">
			<img src="../../images/hezhong/abb/abblq_01.png"  alt="">
			<div class="banner_desc">
				<p><span class="left">投保年龄</span><span class="right">28天-17周岁</span></p>
				<p><span class="left">保险期间</span><span class="right">30年</span></p>
				<p><span class="left">最高保障</span><span class="right">40万</span></p>
			</div>
		</div>
		<div class="product_wrapper">
			...
			<div id="nav1" class="product_desc">
				<img src="../../images/hezhong/abb/abblq_02.png" alt="">
			</div>
			<div id="nav2" class="product_desc">
				<img src="../../images/hezhong/abb/abblq_03.png" alt="">
			</div>
			<div id="nav3" class="product_desc">
				<img src="../../images/hezhong/abb/abblq_04.png?v=180228" alt="">
				<div class="recommend_wrapper" style="padding: 0 0 0.7rem 0;">
					<a href="javascript:void(0)"></a>
					<a href="../../contract/hezhong/abb/insuranceClauses.pdf"></a>
					<a href="../../contract/hezhong/abb/add_xxpl.pdf"></a>
				</div>
			</div>
			<div id="nav4" class="product_desc">
				<img src="../../images/hezhong/abb/abblq_05.png?v=180228" alt="">
			</div>
		</div>
		<%--<div class="recommend_wrapper">--%>
			<%--&lt;%&ndash;<p><a href="../../contract/hengqin/lptk.pdf"><span class="left">理赔须知</span><span class="right">查看</span></a></p>&ndash;%&gt;--%>
			<%--<p><a href="../../contract/hezhong/abb/insuranceClauses.pdf"><span class="left">保险条款</span><span class="right">查看</span></a></p>--%>
			<%--&lt;%&ndash;<p><a href="../../contract/hengqin/jxnn/disclosure.pdf"><span class="left">信息披露</span><span class="right">查看</span></a></p>&ndash;%&gt;--%>
		<%--</div>--%>
		<div class="footer_wrapper" id="footer_wrapper">
			...
			<section class="infoList trialCon" style="display:none;">
				<div class="infoSec pl pr bgColor borTop1">
					...
					<dl class="clearfix infoDl borBot1 dlSec"  id="select_BEMoney">
						<dt class="w35 l-float">附加险保额</dt>
						<dd class="w65 l-float txtR hasArrow">
							<%--<input id = "prem" class="w65" type="number" style="padding-right: 0.75rem;"--%>
							<%--onchange = "showprem();" placeholder="填写金额">--%>
							<span  id="show_BEMoney" style="padding-right: 0.75rem;" data-id = 'null'>40万</span>
							<i class="arrow"></i>
						</dd>
					</dl>
					<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
						...
						<dd class="w65 l-float txtR hasArrow">
							<span  id="show_BXTime" style="padding-right: 0.75rem;" data-id = 'null'>30年</span>
							<i class="arrow"></i>
						</dd>
					</dl>
				</div>
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom">
				<dl class="clearfix infoDl w100">
					<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
						<p class="kf_p"><img src="../../images/hengqin/bwyl/red_kf.png?v=20180514" alt="" style="width: 1.5rem;"></p>
						<span readonly="" class="insurePrice" id="insurePrice" >105.00</span><span>元/年起</span>
						<input type="hidden" value = '105.00' id = 'insurePrice_trans'>
					</dt>
...
<script type="text/javascript">
    ...
    function showprem()
    {
        $('#amnt').html(Number($('#prem').val()).toFixed(2));
        $('#amnttxt').html('');
        $('#prem').val(Number($('#prem').val()).toFixed(2))
        showamnt();
    }
    ...
    function showamnt()
    {
        ...
        if($("#show_BEMoney").attr("data-id")!='null')
        {
            getyear = $("#show_BEMoney").attr("data-id");
        }
...
//				"ishuanmian":$("#ishuanmian").find("option:selected").val()
		...
		sendPriceRequest("../../life/hz/getprice02.do",premdata,function (data)
		{
...
//    			}
            ...
            window.location.href = "./toldinfo.do?riskCode=634&payendyear="+payendyear+"&getyear="+getyear+"&sex="+sex+"&age="+age
        }
    });
</script>
<script>
