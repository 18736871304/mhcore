...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hongkang/xbys/xbys_01.png?v=20190316"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-60周岁</span></p>
					<p><span class="left">保障期限</span><span class="right">终生</span></p>
					<p><span class="left">缴费方式</span><span class="right">10/20年</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/xbys/xbys_02.png?v=20190316" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/xbys/xbys_03.png?v=20190316" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/xbys/xbys_04.png?v=20190316" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hongkang/xbys/xbys_tb.pdf"></a>
						<a href="../../contract/hongkang/xbys/xbys.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/xbys/xbys_05.png?v=20190316" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'411401','hongkang');
	   })
