...
<body>
		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/jkys/jkys_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/jkys/jkys_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/jkys/jkys_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hongkang/hk-lpxz.pdf"></a>
						<a href="../../contract/hongkang/jkys/hk-jkys.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/jkys/jkys_05.png" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >220.00</span><span>元/年起</span>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'511502','hongkang');
	   })
	   ...
	   //点击立即咨询框，逻辑end
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '健康一生重大疾病险', // 分享标题
		        link: 'http://insure.meihualife.com/life/hongkang/dis_jkys_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hongkang/jkys/jkys-hk-wx.png',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '健康一生重大疾病险', // 分享标题
		        desc: '纯消费类保险，无强制储蓄，不花冤枉钱，全网最低价', // 分享描述
		        link: 'http://insure.meihualife.com/life/hongkang/dis_jkys_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hongkang/jkys/jkys-hk-wx.png',
