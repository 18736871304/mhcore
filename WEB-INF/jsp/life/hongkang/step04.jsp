...
<head>
    ...
    <script src="../../js/hongkang/payment.js?v=2018080603"></script>
</head>
<body style="">
    ...
    <div class="msgCode-wrap" id = "discheck" hidden = "">
	    <h3 class="pl">手机验证码</h3>
	    <div class="smscode-box">
		    <input id = "smscode"  type="text" value = "${smscode}" placeholder="请输入手机验证码" >
			<span id="dd" class="gainCode" >获取验证码</span>
			<span id="yc" class="gainCode" style="display: none"></span>
    ...
    <section class="infoList">
        <div class="ml whetherRead pr">
            ...
            <span>我已认真阅读
				<a href="<%=request.getContextPath()%>/contract/hongkang/hongkang_payment.pdf">《银行转账授权声明书》</a>并同意上述协议规定。
			</span>
        </div>
    </section>
