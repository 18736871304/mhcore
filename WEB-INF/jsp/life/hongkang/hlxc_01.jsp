...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hongkang/hlxc/hlxczcsx_01.png"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/hlxc/hlxczcsx_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/hlxc/hlxczcsx_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/hlxc/hlxczcsx_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hongkang/hk-lpxz.pdf"></a>
						<a href="../../contract/hongkang/hlxc/hk-hlxc.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/hlxc/hlxczcsx_05.png" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >480.00</span><span>元/年起</span>
				            <input type="hidden" value = '480.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'511101','hongkang');
	   })
