...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/jxnn/jxnn_01.png?v=20190316"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_02.png?v=20190316" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_03.png?v=20190316" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_04.png?v=20190316" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_05.png?v=20190316" alt="">
				</div>
			</div>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'14040','hengqin');
	   })
