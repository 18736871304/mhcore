...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="16050">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/hengqin/ykb/insuranceClauses.pdf">《保险条款》</a>
