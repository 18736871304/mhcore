	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/ykb/ykb_01.png?v=20180420"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/ykb/ykb_02.png?v=20180420" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/ykb/ykb_03.png?v=20180420" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/ykb/ykb_04.png?v=20180420" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/yjwn/yjwn_05.png?v=20180420" alt="">
				</div>
			</div>
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
		                 ...
		                 <dl class="clearfix infoDl dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        ...
		                        <span id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>5万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >305.00</span><span>元/年起</span>
				            <input type="hidden" value = '305.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=16050&payendyear="+payendyear+"&amnt="+amnt+"&prem="+prem
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        ...
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_ykb_01.do?reuserid='+reuserid, // 分享链接
		       	imgUrl: 'http://insure.meihualife.com/images/hengqin/ykb/ykb_hq_wx.png',
