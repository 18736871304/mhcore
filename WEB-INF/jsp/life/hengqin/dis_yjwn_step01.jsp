...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/yjwn/yjwn_01.png?v=20190316"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/yjwn/yjwn_02.png?v=20190316" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/yjwn/yjwn_03.png?v=20190316" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/yjwn/yjwn_04.png?v=20190316" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/yjwn/yjwn_05.png?v=20190316" alt="">
				</div>
			</div>
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <input type="hidden" value = '10.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'34010','hengqin');
	   })
