...
<head>
    ...
    <script src=" ../../js/hengqin/sjMain.js?v=180427"></script>
    <style>
		.recommend_wrapper{
			position: absolute;
			left: 0;
	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/yab/yab01.png?v=20180420_01"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/yab/yab02.png?v=20180420_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/yab/yab03.png?v=20180420_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/yab/yab04.png?v=20180420_01" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hengqin/lptk.pdf"></a>
						<a href="../../contract/hengqin/yab/insuranceClauses.pdf"></a>
						<a href="../../contract/hengqin/yab/disclosure.pdf"></a>
					</div>
				</div>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=11010&payendyear="+payendyear+"&amnt="+amnt+"&prem="+prem
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '优爱宝终身寿险', // 分享标题
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_yab_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/yab/yab_hq_wx.png',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '优爱宝终身寿险', // 分享标题
		        desc: '良心打造的旗舰产品，真正逼疯精算师，性价比爆表', // 分享描述
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_yab_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/yab/yab_hq_wx.png',
