...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="11010">
			        ...
			        <dl class="clearfix borBot1 dlSec">
				        ...
				        <dd class="w65 l-float txtR hasArrow">
					        <select id = "payendyear" class="premium txtR iFactor getPrice PaymentDeadline dw-hsel" tabindex="-1">
						        <option value="100Y">交至100岁</option>
...
<!--不一致时被保人信息-->
                    <div class="insured" style="display: none;">
                        ...
                        <dl class="clearfix infoDl borTop1 dlSec xingbie2" style="display: none;">
                            <dt class="w35 l-float">性别</dt>
                            <dd class="w65 l-float txtR hasArrow my_leftS">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/disclosure.pdf">《产品信息披露表》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/insureNote_wangxiao.pdf">《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/insuranceClauses.pdf">《保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/iInsurancePolicy_qgwangxiao.pdf.pdf">《投保须知》</a>
