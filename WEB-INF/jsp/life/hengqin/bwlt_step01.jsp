	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/bwlt/bwlt_01.jpg"  alt="">
			</div>
			<div class="product_wrapper">
				<div id="nav">
					<div class="product_nav">
						<a href="javascript:;" class="active_nav"><span>产品特色</span></a>
						<a href="javascript:;"><span>保险责任</span></a>
						<a href="javascript:;"><span>保险案例</span></a>
						<a href="javascript:;"><span>理赔流程</span></a>
					</div>
				</div>
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/bwlt/bwlt_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/bwlt/bwlt_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/bwlt/bwlt_04.png" alt="">
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/ykb/ykb_04.png?" alt="">
				</div>
			</div>
			<div class="recommend_wrapper">
				<p><a href="../../contract/hengqin/lptk.pdf"><span class="left">理赔须知</span><span class="right">查看</span></a></p>
				<p><a href="../../contract/hengqin/ykb/insuranceClauses.pdf"><span class="left">保险条款</span><span class="right">查看</span></a></p>
				<p><a href="../../contract/hengqin/ykb/disclosure.pdf"><span class="left">信息披露</span><span class="right">查看</span></a></p>
			</div>
	                ...
	                <div class="infoSec pl pr bgColor borTop1">
	                	<dl class="clearfix infoDl borBot1 dlSec"  id="selectDate">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="showDate" style="padding-right: 0.75rem;" data-year = 'null'>2000-01-23</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_BXTime" style="padding-right: 0.75rem;" data-id = 'null'>20年</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
    			...
    			if($('#insurePrice').html()!=null&&$('#insurePrice').html()!="")
    			{
    				prem = $('#insurePrice').html().substring(0,$('#insurePrice').html().length-2);
    			}
        		...
        		window.location.href = "./toldinfo.do?riskCode=13020&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '横琴优康保终身重大疾病保险', // 分享标题
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_ykb_01.do?reuserid='+reuserid, // 分享链接
		       	imgUrl: 'http://insure.meihualife.com/images/hengqin/ykb/ykb_wx.jpg',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '横琴优康保终身重大疾病保险', // 分享标题
		        desc: '保百病，赔6次，人人必备的终身重疾险，还能有电话医生提供健康咨询', // 分享描述
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_ykb_01.do?reuserid='+reuserid, // 分享链接
		       	imgUrl: 'http://insure.meihualife.com/images/hengqin/ykb/ykb_wx.jpg',
