	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/pinganyl/czwy/czyybwx_01.png?v=20180420"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">18周岁-65周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">1年</span></p>
					<p><span class="left">最高保障</span><span class="right">105万</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/pinganyl/czwy/czyybwx_02.png?v=20180420" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/pinganyl/czwy/czyybwx_03.png?v=20180831" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/pinganyl/czwy/czyybwx_04.png?v=20180420" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/pinganyl/czwy/toubaoxz.pdf"></a>
						<a href="../../contract/pinganyl/czwy/jiachengywshx_tk.pdf"></a>
						<a href="../../contract/pinganyl/czwy/2017nianduxinxipilubaogao.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/pinganyl/czwy/czyybwx_05.png?v=20180420" alt="">
				</div>
			</div>
			<div class="footer_wrapper" id="footer_wrapper">
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id = "select_sex" style="display:none;">
		                	<dt class="w35 l-float">性别</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_sex" style="padding-right: 0.75rem;" data-id = 'null'>女</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_JFTime" style="display:none;">
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
		                 ...
		                 <dl class="clearfix infoDl dlSec"  id="select_amnt" style="display:none;">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        ...
		                        <span id="show_amnt" onchange = "showprem();" style="padding-right: 0.75rem;" data-id = 'null'>105万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >200.00</span><span>元/年起</span>
				            <input type="hidden" value = '200.00' id = 'insurePrice_trans'>
		            	</dt>
...
//				"ishuanmian":$("#ishuanmian").find("option:selected").val()
			...
			sendPriceRequest("../../life/pinganyl/getprice02.do",premdata,function (data)
			{
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=P0450J05&prem="+prem;
        	}	
		});
	</script>
	<script>
