		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/pinganyl/kaxf/kaxfx_02.png?v=20180420" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/pinganyl/kaxf/kaxfx_03.png?v=20180420" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/pinganyl/kaxf/kaxfx_04.png?v=20180420" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/pinganyl/kaxf/toubaoxz.pdf"></a>
						<a href="../../contract/pinganyl/kaxf/kaxf_tk.pdf"></a>
						<a href="../../contract/pinganyl/czwy/2017nianduxinxipilubaogao.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/pinganyl/kaxf/kaxfx_05.png?v=20180420" alt="">
				</div>
			</div>
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BXTime">
		                 ...
		                 <dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        ...
		                        <span id="show_amnt" onchange = "showprem();" style="padding-right: 0.75rem;" data-id = 'null'>20万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >14.00</span><span>元/年起</span>
				            <input type="hidden" value = '14.00' id = 'insurePrice_trans'>
		            	</dt>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=P0352&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem;
        	}	
		});
	</script>
	<script>
