...
<head>
    ...
    <title>投保信息</title>
    <link rel="stylesheet" href="../../css/hezhong/infos.css?v=20181220">
    ...
    <script src=" ../../js/pinganyl/insuranceInformation.js?v=20180831"></script>
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="P0450J05">
            <input type="text" style="display:none" class="personInfo" id="insOrganCode" value="pinganyl">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        <dl class="clearfix borBot1 dlSec" style="display: none">
				        ...
				        <dd class="w65 l-float txtR hasArrow">
					        <select id = "payendyear" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
					...
					<dl class="clearfix infoDl borBot1 dlSec" >
				        <dt class="w35 l-float">意外伤害保额</dt>
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input class="textfield txtR personInfo" id = "bz_amnt" type="text" value = "50万元" readonly="">
						</dd>
				        <span class="errorMsg"></span>
			        </dl>
			     	<dl class="clearfix borBot1 dlSec" >
				        <dt class="w35 l-float">意外伤残保额</dt>
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input class="textfield txtR personInfo" id = "sgsc_amnt" type="text" value = "50万元" readonly="readonly">
						</dd>
				        <span class="errorMsg"></span>
			        </dl>
			        <dl class="clearfix borBot1 dlSec" >
				        <dt class="w35 l-float">意外医疗保额</dt>
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input class="textfield txtR personInfo" id = "sgsc_amnt" type="text" value = "5万元" readonly="readonly">
						</dd>
				        <span class="errorMsg"></span>
			        </dl>
			        <dl class="clearfix infoDl borBot1 dlSec" style="display: none">
						...
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input class="textfield txtR personInfo" id = "amnt" type="text" value = "1050000" readonly="">
						</dd>
				        <span class="errorMsg"></span>
			        </dl> 
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input id = "prem" type="text" value = "200.00" readonly="readonly" 
 ...
 <!--受益人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/pinganyl/czwy/toubaoxz.pdf?v=20181220">《投保须知-车主无忧百万保》</a>
		            <a href="<%=request.getContextPath()%>/contract/pinganyl/czwy/jiachengywshx_tk.pdf">《平安驾乘人员团体意外伤害保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/pinganyl/czwy/jiachengywshx_fjtk.pdf">《平安附加驾乘人员意外伤害团体医疗保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/payangl_customerNotification.pdf">《客户告知书》</a></span>
		        </div>
		    </section>
        </form>
        <!--投保按钮-->
        <div class="pl bgColor fixedBox w100" >
            <dl class="clearfix infoDl w100">
	            <dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				    ...
				    <span readonly="" class="insurePrice" id="insurePrice" >200.00</span><span id = "priceunit">元/年</span>
	            </dt>
