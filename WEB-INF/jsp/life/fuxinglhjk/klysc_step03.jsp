...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>投保信息</title>
    <link rel="stylesheet" href="../../css/hezhong/infos.css?v=20190326">
    ...
    <script src=" ../../js/fuxinglhjk/insuranceInformation.js?v=20190729"></script>
    ...
    <script>
        ...
        $(function () 
        {
        	...
        	/*
        	if(ishuomian!=null&&ishuomian!="")
        	{
        		$("#ishuomian").val(ishuomian);
...
<body style="">
    ...
    <header class="header w100 pl bgColor">
        <span>复星联合康乐一生（C款升级款）</span>
        <br/>
        <span>本产品由复星联合健康保险股份有限公司承保</span>
        <img src="../../images/fuxinglhjk/fuxing_input_logo.png?v=20190330" />
    </header>
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="110025">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="110025">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110025/kang-C-tk.pdf">《康C-保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110025/kang-C-hm-tk.pdf" id="hmtk">《附加投保人豁免条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110025/kang-C-tbxz.pdf">《投保须知》</a>
