...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/hengqin/checkFn.js?v=20190323"></script>
    <script src=" ../../js/fuxinglhjk/insuranceInformation.js?v=20190408"></script>
    ...
    <script>
        ...
        $(function () 
        {
        	...
        	{
        		$("#iszl").val(iszl);
        		$("#iszl_dummy").val($("#iszl").find("option:selected").text());
        	}
...
<body style="">
    ...
    <header class="header w100 pl bgColor">
        <span>复星联合康乐一生重疾险c款升级版</span>
        <br/>
        <span>本产品由复星联合健康保险股份有限公司承保</span>
        
        <br>
        <span>温馨提示：保险缴费期内累计应缴保费大于等于20万元，需要同时提供投保人和被保险人的身份证正反面。</span>
        
        <img src="../../images/fuxinglhjk/fuxing_input_logo.png" />
    </header>
     -->
     
    <header class="header w100 pl bgColor">
        <span>复星联合康乐一生加倍保重疾险</span>
        <br/>
        <span>本产品由复星联合健康保险股份有限公司承保</span>
        <img src="../../images/fuxinglhjk/fuxing_input_logo.png?v=20190328" />
    </header>
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="110048">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="110048">
            <input type="text" style="display:none" class="personInfo" id="hmriskcode" value="120011">
            <input type="text" style="display:none" class="personInfo" id="zlriskcode" value="120017">
            ...
            <input type="text" style="display:none" class="personInfo" id="zlPrice" value="0">
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w65 l-float txtR hasArrow">
			                <select id = "iszl" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
 ...
 <!--投保人信息-->
            <section class="infoList">
            	...
            	<p class="ml">投保人信息</p>
            	<span class="tip02 ml">*温馨提示：保险缴费期内累计应缴保费大于等于20万元，需要同时提供投保人和被保险人的身份证正反面。</span>
                <div class="infoSec pl pr bgColor borTop1 borBot1">
...
<!--不一致时被保人信息-->
			        ...
			        <dl class="clearfix infoDl borTop1 dlSec">
                        ...
                        <dd class="w65 l-float txtR hasArrow">
                            <select id="occupation" name="insuredList[0].insuredOccupation3" class="occupation txtR personInfo dw-hsel" tabindex="-1">
                            	<option value="">请选择</option>
                                <option value="000101">机关公务员/企事业单位内勤</option>
                        		<option value="000101">公司内勤/行政/人力等办公室工作</option>
                        		<option value="000101">公司外勤/销售/市场等联系工作</option>
...
<!--续缴账户信息-->
                    ...
                    <dl class="clearfix infoDl borBot1 dlSec">
                        ...
                        <dd class="w65 l-float txtR hasArrow">
                            ...
                            <select name="renewalBank.bankCode" id="accountBank" class="accountBank txtR personInfo dw-hsel" tabindex="-1">
								...
								<!-- <option value="9002">招商银行</option> -->
								<option value="9003">民生银行</option>
								<option value="9004">中信银行</option>
								<!-- <option value="9005">兴业银行</option> -->
								<option value="9006">中国银行</option>
								<option value="9007">交通银行</option>
								<option value="9008">建设银行</option>
								<!-- <option value="9009">汇丰银行</option> -->
								<option value="9010">农业银行</option>
								<option value="9011">浦发银行</option>
								<option value="9013">光大银行</option>
								<!-- <option value="9014">恒丰银行</option> -->
								<option value="9015">邮储银行</option>
								<!-- <option value="9016">北京银行</option> -->
								<!-- <option value="9017">农业发展银行</option> -->
								<!-- <option value="9019">华夏银行</option> -->
								<option value="9020">广发银行</option>
								<option value="9021">上海银行</option>
								<!-- <option value="9022">宁波银行</option> -->
								<!-- <option value="9023">东亚银行</option> -->
								<!-- <option value="9024">南洋商业银行</option> -->
								<!-- <option value="9025">恒生银行(中国)有限公司</option> -->
								<!-- <option value="9026">星展银行(中国)有限公司</option> -->
								<!-- <option value="9027">厦门国际银行</option> -->
								<!-- <option value="9028">浙商银行</option> -->
								<!-- <option value="9039">平安银行</option> -->
                            </select>
                            <i class="arrow"></i>
                        </dd>
                        <span class="errorMsg"></span>
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110048/110048-tk.pdf">《加倍保-保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/120017/120017-tk.pdf" id="zltk">《附加恶性肿瘤条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110025/kang-C-hm-tk.pdf" id="hmtk">《附加投保人豁免条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110048/jbb-tbxz.pdf?v=20190408">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110025/kang-C-tbts.pdf" >《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/tax.pdf" >《中国税收居民声明》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/fuxing-payment.pdf" >《扣款知情书》</a>
		            <!-- 
		            
		            <a href="<%=request.getContextPath()%>/contract/hengqin/insureNote_wangxiao.pdf">《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/ykb/declarationsConfirm_wangxiao.pdf">《告知声明书》</a>
		            
		            <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/hengqin_customerNotification.pdf">《客户告知书》</a>
		             -->
		            </span>
		        </div>
		    </section>
