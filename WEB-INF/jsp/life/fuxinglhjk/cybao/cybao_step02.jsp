...
<body>
	<div>
		<div class="content">
			<p>投保人应在对所有被保险人健康/职业状况充分了解的基础上履行如实告知义务。投保人承诺完全知晓所有被保险人健康/职业状况。若被保险人健康/职业状况与告知内容不符：</p>
			<p>（1）本公司有权不同意承保。 </p>
			<p>（2）若发生保险事故，本公司不承担赔偿或给付保险金的责任，并有权不退还保险费。</p>
			<p>投保人确认被保险人是否有以下情况：</p>
			<p>1、过去2年内投保人身保险或健康保险时，被保险公司拒保、延期、加费或者附加条件承保。</P>
			<p>2、目前从事高危职业 (见高危职业表)。</P>
			<p>3、过去1年内有健康检查结果异常（如血液、超声、影像、内镜、病理检查）或连续服药超过30天；过去2年曾住院（不包括剖腹产/顺产/鼻炎/急性胃肠炎/肺炎/上呼吸道感染住院）或被医生建议进一步检查、手术或治疗。</P>
			...
			<p>7、2周岁（含）以下被保险人：出生时体重低于2.5公斤，有早产/窒息/发育迟缓/脑瘫。</P>
		</div>
		<div class="clearfix bottomBtn-wrap">
			...
			<input type="hidden" name="riskCode" id="riskCode" value="110068">
