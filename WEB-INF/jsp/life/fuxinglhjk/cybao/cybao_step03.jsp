...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/fuxinglhjk/insuranceInformation.js?v=201901216_01"></script>
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="110068">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="110068">
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w65 l-float txtR hasArrow">
			                <select id = "productplan" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
								<option value="01">专家版</option>
						        <option value="02">特需版</option>
				            </select>
			                <i class="arrow"></i>
						</dd>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-tk.pdf?v=20200103">《超越保-保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-tbxz.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-tbts.pdf" >《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-zrmc.pdf" >《责任免除等重要事项说明书》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-zdxb.pdf" >《自动续保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110068/110068-gw-job.pdf" >《高危职业》</a>
