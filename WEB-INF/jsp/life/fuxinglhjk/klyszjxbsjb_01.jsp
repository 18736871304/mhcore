...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/fuxinglhjk/klysjkxbsjb/klyszjxbsjb_01.png"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/fuxinglhjk/klysjkxbsjb/klyszjxbsjb_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/fuxinglhjk/klysjkxbsjb/klyszjxbsjb_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/fuxinglhjk/klysjkxbsjb/klyszjxbsjb_04.png" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/fuxinglhjk/klysjkxbsjb/klyszjxbsjb_05.png" alt="">
				</div>
			</div>
			<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >323.00</span><span>元/年起</span>
				            <input type="hidden" value = '323.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'110021','fuxinglhjk');
	   })
