	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/fuxinglhjk/110048/110048_01.png?v=20190321"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/fuxinglhjk/110048/110048_02.png?v=20190321" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/fuxinglhjk/110048/110048_03.png?v=20190321" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/fuxinglhjk/110048/110048_04.png?v=20190321" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/fuxinglhjk/110048/110048_05.png?v=20190321" alt="">
				</div>
			</div>
			<div class="footer_wrapper" id="footer_wrapper">
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl dlSec"  id="select_exzl">
		                	<dt class="w35 l-float">附加恶性肿瘤</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_exzl" style="padding-right: 0.75rem;" data-id = 'null'>投保</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	...
	<script>
        $('.footer_go').click(function()
        {
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=110048&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem+"&ishuomian="+ishuomian+"&iszl="+iszl;
        	}
		});
	</script>
	<script>
