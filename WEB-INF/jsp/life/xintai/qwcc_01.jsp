...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/xintai/qwcc/qwcc_01.png"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">28天-75周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">终身</span></p>
					<p><span class="left">起投金额</span><span class="right">10000元</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/xintai/qwcc/qwcc_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/xintai/qwcc/qwcc_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/xintai/qwcc/qwcc_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="javascript:;"></a>
						<a href="../../contract/xintai/qwcc/qwcc.pdf"></a>
						<a href="javascript:;"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/xintai/qwcc/qwcc_05.png" alt="">
				</div>
			</div>
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >10000.00</span><span>元/年起</span>
				            <input type="hidden" value = '10000.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'11C00020','xintai');
	   })
	   ...
	   //点击立即咨询框，逻辑end
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '千万传承C终身寿险', // 分享标题
		        link: 'http://insure.meihualife.com/life/xintai/dis_qwcc_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/xintai/qwcc/qwcc_xt_wx.png',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '千万传承C终身寿险', // 分享标题
		        desc: '一张保单，三代收益，稳定增值，提前锁定未来财富', // 分享描述
		        link: 'http://insure.meihualife.com/life/xintai/dis_qwcc_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/xintai/qwcc/qwcc_xt_wx.png',
