...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/xintai/qwrs/qwrs_01.png"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/xintai/qwrs/qwrs_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/xintai/qwrs/qwrs_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/xintai/qwrs/qwrs_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="javascript:;"></a>
						<a href="../../contract/xintai/qwrs/qwrs.pdf"></a>
						<a href="javascript:;"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/xintai/qwrs/qwrs_05.png" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'12D00080','xintai');
	   })
	...
	wx.ready(function () {	//朋友圈
	   	wx.onMenuShareTimeline({
	        title: '千万人生养老年金险', // 分享标题
	        link: 'http://insure.meihualife.com/life/xintai/dis_qwrs_01.do?reuserid='+reuserid, // 分享链接
	        imgUrl: 'http://insure.meihualife.com/images/xintai/qwrs/qwrs_xt_wx.png',
	    ...
	    wx.onMenuShareAppMessage({
	        title: '千万人生养老年金险', // 分享标题
	        desc: '首款针对品质养老的专款专用产品，简单、安全、稳定', // 分享描述
	        link: 'http://insure.meihualife.com/life/xintai/dis_qwrs_01.do?reuserid='+reuserid, // 分享链接
	        imgUrl: 'http://insure.meihualife.com/images/xintai/qwrs/qwrs_xt_wx.png',
