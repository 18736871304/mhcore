...
<body>
		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/xintai/jkwy/jkwy_02.png?v=20180419_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/xintai/jkwy/jkwy_03.png?v=20180419_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/xintai/jkwy/jkwy_04.png?v=20180419_01" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/xintai/jkwy/jkwy_05.png?v=20180419_01" alt="">
				</div>
			</div>
	                ...
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_ishuomian">
		                 ...
		                 <dl class="clearfix infoDl borBot1 dlSec"  id="select_ADDBXTime">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_ADDBXTime" style="padding-right: 0.75rem;" data-id = 'null'>至75周岁</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	            	</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
						<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
						    ...
						    <span readonly="" class="insurePrice" id="insurePrice" >75.00</span><span>元/年起</span>
				            <input type="hidden" value = '75.00' id = 'insurePrice_trans'>
			            </dt>
    ...
    */
	...
	function showprem()
	{
		...
		var productNo = "xt_risk02";
		var ishuomian = 'Y';
		
		var addinsureyear='75Y';
    ...
    $('.footer_go').click(function()
    {
    	...
    	else
    	{
    		...
    		window.location.href = "../../life/xintai/toldinfo.do?riskCode=13F00220&payendyear="+payendyear+"&amnt="+amnt+"&age="+age+"&prem="+prem+"&ishuomian="+ishuomian+"&addinsureyear="+addinsureyear+"&productNo="+productNo;
    	}
	});
	</script>
	<script>
