...
<head>
    ...
    <link rel="stylesheet" href="../../css/hengqin/index.css?v=180411">
    <script src="http://res.wx.qq.com/open/js/jweixin-1.2.0.js?v=180411"></script>
    <script src=" ../../js/hengqin/jquery-1.10.1.min.js?v=180411"></script>
    <script src=" ../../js/hengqin/sjMain.js?v=180416"></script>
    <script src=" ../../js/common/insuCommon.js?v=20180422"></script>
    <script src=" ../../js/common/intention.js?v=20180422"></script>
    <style type="text/css">
        #nav1,#nav2,#nav3,#nav4{
            padding: 0;
        }
...
<div class="index_wrapper">
    <div class="main_wrapper">
        <div class="banner_wrapper">
            <img src="../../images/xintai/bwjk/bwjkzzj_01.png?v=20190316"  alt="">
        ...
        <div class="product_wrapper">
            ...
            <div id="nav1" class="product_desc">
                <img src="../../images/xintai/bwjk/bwjkzzj_02.png" alt="">
            </div>
            <div id="nav2" class="product_desc">
                <img src="../../images/xintai/bwjk/bwjkzzj_03.png" alt="">
            </div>
            <div id="nav3" class="product_desc">
                <img src="../../images/xintai/bwjk/bwjkzzj_04.png" alt="">
                <div class="recommend_wrapper">
                    <a href="javascript:;"></a>
                    <a href="../../contract/xintai/bwjk/bwjk.pdf"></a>
                    <a href="javascript:;"></a>
                </div>
            </div>
            <div id="nav4" class="product_desc">
                <img src="../../images/xintai/bwjk/bwjkzzj_05.png" alt="">
            </div>
        </div>
        <!-- <div class="recommend_wrapper">
        ...
        <div class="pl bgColor fixedBox w100 hq-productBottom">
            <dl class="clearfix infoDl w100">
                <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
                    ...
                    <span readonly="" class="insurePrice" id="insurePrice" >325.00</span><span>元/年起</span>
...
<script>
    ...
    $('.confirm-btn').on('click',function()
    {
        ...
        intentionInsert(mobile,'14D00080','xintai');
    })
    ...
    wx.ready(function () {	//朋友圈
        wx.onMenuShareTimeline({
            title: '百万健康重疾险', // 分享标题
            link: 'http://insure.meihualife.com/life/xintai/dis_bwjk_01?reuserid='+reuserid, // 分享链接
            imgUrl: 'http://insure.meihualife.com/images/xintai/bwjk/bwjkzzj_01.png',
        ...
        wx.onMenuShareAppMessage({
            title: '百万健康重疾险', // 分享标题
            desc: '陪你面对人生的每一种可能', // 分享描述
            link: 'http://insure.meihualife.com/life/xintai/dis_bwjk_01.do?reuserid='+reuserid, // 分享链接
            imgUrl: 'http://insure.meihualife.com/images/xintai/bwjk/bwjk_wx.png',
