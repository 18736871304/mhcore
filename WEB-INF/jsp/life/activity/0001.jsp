...
<html>
	<head>
		<title>免费对比86家保险公司产品_立即在线预约</title>
		<meta charset="utf-8" name="viewport" content="width=device-width,initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
		<!-- <title>美华保险</title> -->
		<link rel="stylesheet" href="../../css/20190824/css.css?v=20191025" />
				...
				sendRequest("../../life/activity/getChannelData.do",transdata,function (data) 
				{
					var obj = JSON.parse(data);
				   	...
				   	if(obj.code == '00')
				   	{
						...
						meteor.track('form', {convert_id: '1643628449222663' })
				   	}
				   	else
				   	{
	...
	<body>
		...
		<img src="../../images/20190824/mianfeidb_01.jpg?v=20190920" width="100%" height="28%"/>
		<!-- 
		<img src="../../images/20190824/youbei_02.jpg" width="100%" height="28%"/>
		 -->
		<img id="clickmd" src="../../images/20190824/mianfeidb_06.jpg" width="100%" height="28%"/>
	<form class="form-box" id="myform">
		<div id="hqbdfa">
			...
			<input type = "button" class="ljcs" id="dz1" value="立即在线预约" onclick = "getdata01()">
		</div>
		<!-- <div id="showModel">
			<button type="submit" class="ljcs">免费领取定制方案</button>
		</div> -->
	</form>
		<img style="width:100%;height: auto;" src="../../images/20190824/mianfeidb_03.jpg?v=20190920"/>
		<img style="width:100%;height: 450%;" src="../../images/20190824/mianfeidb_04.jpg"/>
		<img style="width:100%;height: 450%;" src="../../images/20190824/mianfeidb_06.jpg"/>
		
		<!-- 
		<img style="width:100%;height: 180%;" src="../../images/20190824/youbei_08.jpg"/>
		<img style="width:100%;height: 400%;" src="../../images/20190824/youbei_09.jpg"/>
		<img style="width:100%;height: 400%;" src="../../images/20190824/youbei_10.jpg"/>
		 -->
	...
	<form  class="form-box" id="myform1">
		<div id="hqbdfa">
			...
			<input type = "button" class="ljcs" id="dz1" value="立即在线预约" onclick = "getdata02()">
		</div>
		<!-- <div id="showModel">
			<button type="submit" class="ljcs">免费领取定制方案</button>
		</div> -->
	...
	<img style="width:100%;height: 180%;" src="../../images/20190824/mianfeidb_05.jpg"/>
	
	<br></br>
	<div class="hqbxfa">
		<button class="zt"><a href="#clickmd">立即在线预约</a></button>	
	</div>
