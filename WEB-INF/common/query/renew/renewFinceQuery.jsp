...
<table class="common">
	...
	<tr>
		...
		<td class = "report_common">
			<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="qrefincestate" id="qrefincestate">
			</select>
		</td>
		...
		<td class = "report_common">
			<input class="easyui-datebox" style="width: 160%" id="qreinvoicemonth" name="qreinvoicemonth">
		</td>
	...
	<tr>
		...
		<td class="report_common">
			<select class="easyui-combobox" style="width:160%" panelHeight="auto" name="qrestate" id="qrestate" data-options="multiple:true">
			</select>
		</td>
	</tr>
...
function initRenewQuery(hasSum)
{
	...
	disComBox($('#qrefincestate'),"fincestate",null);
	...
	$('#qreinvoicemonth').datebox({formatter:function(date){
...
function getRenewQueryParam() 
{
	...
	tParam.refincestate = $('#qrefincestate').combobox('getValue');
	tParam.reinvoicemonth = $('#qreinvoicemonth').datebox("getValue");
