$(function () {
    ...
    */
    ...
    $(".insureBtn").on("click", function () 
    {
        ...
        sendRequest("../../life/hq/contractpay_save.do",{"orderNo":$("#orderNo").val(),"serialNo":$("#serialNo").val(),"smscode":$("#smscode").val()},function(data)
        {
        	var obj = JSON.parse(data);
            console.log(obj);
            paybak();
...
function paybak(){
	sendRequest("../../life/hq/getpaybakinfo.do",{"orderNo":$("#orderNo").val()},function(data)
        {
        	var obj = JSON.parse(data);
