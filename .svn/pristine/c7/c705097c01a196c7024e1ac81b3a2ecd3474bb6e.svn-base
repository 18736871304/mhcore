	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/fuxinglhjk/110068/110068_01.jpg?v=20200213"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/fuxinglhjk/110068/110068_02.jpg?v=20200213" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/fuxinglhjk/110068/110068_03.png?v=20191227_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/fuxinglhjk/110068/110068_04.png?v=20191227_01" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/fuxinglhjk/110068/110068_05.png?v=20191227_01" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_productplan">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_productplan" style="padding-right: 0.75rem;" data-id = 'null'>专家版</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >273.00</span><span>元/年起</span>
				            <input type="hidden" value = '273.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
        $('.footer_go').click(function()
        {
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=110068&prem="+prem+"&productplan="+productplan+"&hassocialinsurance="+hassocialinsurance;
        	}
		});
	</script>
	<script>
