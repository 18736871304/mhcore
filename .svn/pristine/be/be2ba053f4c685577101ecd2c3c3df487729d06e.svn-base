	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hongkang/bbjzj/hkbbj_01.jpg?v=20191203"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-55周岁</span></p>
					<p><span class="left">保障期限</span><span class="right">终身</span></p>
					<p><span class="left">最高保障</span><span class="right">80万</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_02.png?v=20191203" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_03.jpg?v=20191203" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_04.png?v=20191203" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_05.jpg?v=20191203" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>80万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >44.62</span><span>元/月起</span>
				            <input type="hidden" value = '44.62' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
        $('.footer_go').click(function()
        {
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=hongkang000015_yue"
