...
<head>
	...
	<link rel="stylesheet" href="../../css/hengqin/index.css?v=180522">
	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hengqin/yab/yabds-01.png"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">18-60周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">最高保至70周岁</span></p>
					<p><span class="left">最高保障</span><span class="right">150万</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/yab/yabds_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/yab/yabds_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/yab/yabds-04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hengqin/lptk.pdf"></a>
						<a href="../../contract/hengqin/yab/yabdsInsuranceClauses.pdf"></a>
						<a href="../../contract/hengqin/yab/yabdsDisclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/yab/yabds-05.png?v=180428" alt="">
				</div>
			</div>
		                ...
		                <dl class="clearfix infoDl dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <!-- <input id = "amnt" class="w65" type="number" style="padding-right: 0.75rem;width: 100%;"
		                       	...
		                       	<span id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>30万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=12030&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '优爱宝定期寿险', // 分享标题
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_yabds_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/yab/yabds_hq_wx.png',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '优爱宝定期寿险', // 分享标题
		        desc: '小投入高杠杆，150万保额免体检，附加两大增值服务', // 分享描述
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_yabds_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/yab/yabds_hq_wx.png',
