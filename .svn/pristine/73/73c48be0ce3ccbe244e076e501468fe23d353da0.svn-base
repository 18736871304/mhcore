...
<div style="margin-left:0%">
	...
	<table class = "common">
		<tr>
			...
			<td class = "report_common_4">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" name="amnttype" id="amnttype" notnull = "保险金额类型">
				</select>
			</td>
	...
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "riskamntInsert" onclick = "riskamntInsert()">保险金额录入</a>
	</div>
	...
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "amntlistInsert" onclick = "amntlistInsert()">保险金额录入</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id = "amntlistUpdate" onclick = "amntlistUpdate()">保险金额修改</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id = "amntlistDelete" onclick = "amntlistDelete()">保险金额删除</a>
	</div>
</div>
</body>
</html>
