...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="17040">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	<dl class="clearfix borBot1 dlSec">
				        ...
				        <dd class="w65 l-float txtR hasArrow">
					        <select id = "plan" class="premium txtR iFactor getPrice dw-hsel personInfo" tabindex="-1" onblur="bwylamntBlur(this)">
			        ...
			        <dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float hasArrow pr" style="box-sizing: border-box;">
						    <input id = "amnt" type="text" value ="${amnt}" class="only iFactor getPrice import" 
                ...
                <dl class="clearfix infoDl borBot1 dlSec">
                	...
                	<dd class="w65 l-float txtR hasArrow">
                	    ...
                	    <input type="text" id="cardType_dummy" class="tmp" placeholder="" readonly="" style="color: rgb(34, 34, 34);">
                	     -->
                	    <select name="applicant.appntIdcardType" id="cardType" class="cardType txtR personInfo dw-hsel cdtype" onchange="changeCardType(this.value)" tabindex="-1">
                        ...
                        <dl class="clearfix infoDl borTop1 dlSec">
                            ...
                            <dd class="w65 l-float txtR hasArrow">
                                ...
                                <input type="text" id="insuredCardType_dummy" class="tmp" placeholder="" readonly="" style="color: rgb(34, 34, 34);">
                                 -->
                                <select id="insuredCardType" name="insuredList[0].insuredIdcardType" class="cardType txtR personInfo dw-hsel cdtype" onchange="changeInsuredCardType(this.value)" tabindex="-1">
                                	<!-- <option>请选择</option> -->
		                  	         <option value="0">身份证</option>
		                  	       <!--<option value="1">护照</option>
		                  	        <option value="2">军人证或军官证</option>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <%-- <a href="<%=request.getContextPath()%>/contract/hengqin/bwyl/disclosure.pdf">《产品信息披露表》</a> --%>
		            <%-- <a href="<%=request.getContextPath()%>/contract/hengqin/insureNote_wangxiao.pdf">《投保提示书》</a> --%>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/bwyl/insuranceClauses.pdf">《保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/bwyl/iInsurancePolicy_gdwangxiao.pdf">《投保须知》</a><br/>
