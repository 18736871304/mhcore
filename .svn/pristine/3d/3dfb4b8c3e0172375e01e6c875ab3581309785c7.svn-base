...
function riskBaseRateUpdate()
{
	...
	ajaxdeal("supplier/noSillRateUpdate.do",tparam,null,null,saveSuss);
}

function riskBaseRatequery()
{
	var tturl = "supplier/getNoSillRateList.do";
...
<div style="margin-left:0%">
	...
	<br>
	<br>
	<table id="riskBaseRatelist" class="easyui-datagrid" title="无门槛加佣管理" style="width:auto;height:auto"
