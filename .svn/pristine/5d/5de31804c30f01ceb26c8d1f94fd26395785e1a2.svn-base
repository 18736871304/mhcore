...
<div style="margin-left:0%">
	...
	<table class = "common">
		...
		<tr hidden = "">
			...
			<td class = "common">
				<input class = "txt" name="qstaffname" id="qstaffname" readonly onclick = "disuUserDlg($('#qstaffcode'),$('#qstaffid'),$('#qstaffname'));">
				<input type = 'hidden' id = 'qstaffcode'>
				<input type = 'hidden' id = 'qstaffid'>
			</td>
