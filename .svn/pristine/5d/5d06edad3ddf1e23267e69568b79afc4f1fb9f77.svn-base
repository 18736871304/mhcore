$(function () 
{
    ...
    */
    ...
    $("#sureToSave").click(function() {
        ...
        sendRequest("../../life/ab/newcontract_save.do",getData(),function (data) {
        	console.log(data);
        	var obj = JSON.parse(data);
        	if(obj.code == 0){
        		...
        		window.location.href = "../../life/ab/contractpay.do?orderNo="+orderNo;
        		
        		//window.location.href = "../../life/ab/toldinfo.do?orderNo="+orderNo;
            }else{
            	$(".pop").show();
            	$(".mask").show();
            	$(".pop span").text(obj.msg);
...
function calPrice()
{
	...
	sendPriceRequest("../../life/ab/premiumtrial.do",getData(),function (data) 
	{
    	var obj = JSON.parse(data);
    	console.log(obj);
    	if(obj.code == 0)
    	{
    		...
    		//$("#insurePrice").val(obj.insurePrice);
