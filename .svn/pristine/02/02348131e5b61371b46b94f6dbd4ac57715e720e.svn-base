...
<head>
    ...
    <script src=" ../../js/pinganyl/insuranceInformation.js?v=20190410"></script>
...
<body style="">
    <header class="header w100 pl bgColor">
        ...
        <img src="../../images/logo/pingan.png" width="25%"/>
    </header>
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="P0352">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	...
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    <input id = "prem" type="text" value = "${prem}" readonly="readonly" 
 ...
 <!--受益人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/pinganyl/kaxf/toubaoxz.pdf?v=20181220">《投保须知-抗癌先锋防癌险》</a>
		            <a href="<%=request.getContextPath()%>/contract/pinganyl/kaxf/kaxf_tk.pdf">《平安健康守护防癌医疗保险条款》</a>
