...
//    		console.log($(this).data("value"))
    ...
    $("#sureToSave").click(function() {
        ...
        sendRequest("../../life/pinganyl/newcontract_save.do",getData(),function (data) {
        	console.log(data);
        	var obj = JSON.parse(data);
        	if(obj.code == 0){
...
//        		console.log(orderNo);
        		//var returnPage = obj.data.returnPage;
        		window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx37a5a6ceced4f359&redirect_uri=http://insure.meihualife.com/life/pinganyl/contractpay.do&response_type=code&scope=snsapi_base&state="+orderNo+"#wechat_redirect"
//        		window.location.href = "../../life/pinganyl/contractpay.do?orderNo="+orderNo;
        	}else{
            	$(".pop").show();
            	$(".mask").show();
            	$(".pop span").text(obj.msg);
...
function calPrice()
{
	...
	sendPriceRequest("../../life/pinganyl/getprice02.do",getData(),function (data) 
	{
    	var obj = JSON.parse(data);
    	console.log(obj);
    	if(obj.code == 0)
    	{
    		console.log(obj.mainPrice);
			$("#mainPrice").val(obj.mainPrice);
			$("#insurePrice").html(Number(obj.insurePrice).toFixed(2));
			$("#prem").val(Number(obj.insurePrice).toFixed(2));
