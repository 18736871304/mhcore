...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/jklife/8226/8226_01.png?v=2"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/jklife/8226/8226_02.png?v=2" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/jklife/8226/8226_03.png?v=2" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/jklife/8226/8226_04.png?v=2" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/jklife/8226/8226_tb.pdf"></a>
						<a href="../../contract/jklife/8226/8226_tk.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/jklife/8226/8226_05.png?v=2" alt="">
				</div>
			</div>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'8226','jklife');
	   })
