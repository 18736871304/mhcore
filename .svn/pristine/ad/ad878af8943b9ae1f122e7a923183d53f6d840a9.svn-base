...
<body>
		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/jklife/3257/3257_02.png?v=20190316" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/jklife/3257/3257_03.png?v=20190316" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/jklife/3257/3257_04.png?v=20190316" alt="">
					<!-- 
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/jklife/3257/3257_05.png?v=20190316" alt="">
				</div>
			</div>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'3257','jklife');
	   })
