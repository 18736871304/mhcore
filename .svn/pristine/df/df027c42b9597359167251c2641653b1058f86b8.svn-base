...
$(function () 
{
    $(function ()
    {
        ...
        $(function ()
        {
            ...
            {
            	//正式
            	//window.location.href = "../../life/pinganyl/payback.do?orderNo="+$("#orderNo").val();
                ...
                WeixinJSBridge.invoke('getBrandWCPayRequest',repayjson,function(res)
                {
                    ...
                    {
                        window.location.href = "../../life/pinganyl/pageback.do?orderNo="+$("#orderNo").val();
                    }
                    else
                    {
                        $(".pop").show();
                ...
                //测试：
				 /* sendRequest("../../life/pinganyl/payback.do",{'orderNo':$("#orderNo").val()},function (data) {
			        	console.log(data);
...
//			        		console.log(orderNo);
			        		...
			        		window.location.href = "../../life/pinganyl/pageback.do?orderNo="+orderNo;
			        	}else{
			            	$(".pop").show();
			            	$(".mask").show();
