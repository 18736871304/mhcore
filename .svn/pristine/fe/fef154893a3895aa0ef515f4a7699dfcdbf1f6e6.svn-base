             ...
             <dl class="clearfix infoDl borBot1 dlSec">
			    ...
			    <dl class="clearfix borBot1 dlSec" >
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "amnt" class="premium txtR iFactor getPrice dw-hsel getAmntDesc" tabindex="-1" >
								<option value="333000">玛瑙计划</option>
								<option value="222000">珍珠计划</option>
								<option value="111000">钻石计划</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			            <span class="errorMsg"></span>
			    ...
			    <dl class="clearfix borBot1 dlSec" >
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "insuDay" class="premium txtR iFactor getPrice dw-hsel getAmntDesc" tabindex="-1" >
								<option value="1">1年:每次旅行最大天数183天</option>
			   ...
			   <!--  <div id="plan1amnt"> -->
			    <dl class="clearfix infoDl borBot1 dlSec" >
					...
					<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo" id = "bz_amnt" type="text" value = "玛瑙计划" readonly="">
					</dd>
			        <span class="errorMsg"></span>
		        </dl>
		     	<!-- <dl class="clearfix borBot1 dlSec" >
			        <dt class="w35 l-float ">意外身故及伤残</dt>
					<dd class="w65 l-float txtR hasArrow pr " style="box-sizing: border-box;">
					    <input class="textfield txtR personInfo " id = "sgsc_amnt" type="text" value = "30万" readonly="readonly">
					</dd>
			        <span class="errorMsg"></span>
		        </dl> -->
		        </div>
...
<!--不一致时被保人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead1">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/anlian/ozy/ozy_bxtk.pdf">《安联申根之王境外旅行险保险条款》</a>
