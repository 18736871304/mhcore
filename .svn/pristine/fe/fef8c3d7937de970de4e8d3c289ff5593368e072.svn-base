...
<thead>
	<tr>
		...
		<th data-options="field:'organ02name',width:80">出单省公司</th>
		<th data-options="field:'organname',width:80">出单分公司</th>
		<th data-options="field:'agentcom',width:80">出单营业部</th>
		<th data-options="field:'teamname',width:80">出单团队</th>
		...
		<th data-options="field:'revisitstatename',width:80">回访状态</th>
		...
		<th data-options="field:'appphone',width:90">投保人手机号码</th>
		...
		<th data-options="field:'_operate',width:70,formatter:queryPolicyInfo">查看详情</th>
	</tr>
</thead>