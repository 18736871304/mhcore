...
<div style="margin-left:0%">
	...
	<table class = "common">
		<tr>
			...
			<td class = "report_common_4">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" name="payintv" id="payintv" notnull = "缴费频率">
				</select>
			</td>
			<td class = "reprot_title_4">
				排序
	...
	<br>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" id = "payintvInsert" onclick = "payintvInsert()">缴费方式录入</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" id = "payintvUpdate" onclick = "payintvUpdate()">缴费方式修改</a>
	<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id = "payintvDelete" onclick = "payintvDelete()">缴费方式删除</a>
</div>
</body>
</html>
