...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hezhong/acx/acxlqbx_01.png?v=20180420"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hezhong/acx/acxlqbx_02.png?v=20180420" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hezhong/acx/acxlqbx_03.png?v=20180420" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hezhong/acx/acxlqbx_04.png?v=20180420" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hengqin/lptk.pdf" ></a>
						<a href="../../contract/hengqin/ykb/insuranceClauses.pdf"></a>
						<a href="../../contract/hengqin/ykb/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hezhong/acx/acxlqbx_05.png?v=20180420" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_JFTime">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_JFTime" style="padding-right: 0.75rem;" data-id = 'null'>5年</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >736.60</span><span>元/年起</span>
				            <input type="hidden" value = '736.60' id = 'insurePrice_trans'>
			            </dt>
	...
	<script type="text/javascript">
		...
		function showprem()
		{
			...
			if(parseInt(amnt)<10000){
                alert("您输入的金额不能小于最低标准！");
                return;
			}else{
                if(!reg.test(amnt/1000)){
                    alert("您输入的金额不符合要求！");
                    return;
                }
			}
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=637&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem;
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
		    ...
		    wx.onMenuShareAppMessage({
		        title: '优康保重大疾病险', // 分享标题
		        desc: '保百病，赔6次，双豁免，身故还有保险金，人人都必备', // 分享描述
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_ykb_01.do?reuserid='+reuserid, // 分享链接
		       	imgUrl: 'http://insure.meihualife.com/images/hengqin/ykb/ykb_wx.jpg',
