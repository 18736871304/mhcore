...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/fuxinglhjk/110058/110058_01.jpg?v=20200213"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">0-50周岁</span></p>
					<p><span class="left">保障期限</span><span class="right">70岁/80岁/终身</span></p>
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/fuxinglhjk/110058/110058_02.jpg?v=20200213" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/fuxinglhjk/110058/110058_03.png?v=20190509" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/fuxinglhjk/110058/110058_04.png?v=20190509" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/fuxinglhjk/110058/110058_05.png?v=20190509" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <!-- <input id = "amnt" class="w65" type="number" style="padding-right: 0.75rem;width: 100%;"
		                        	onchange = "showprem();" placeholder="50000元起,10000的倍数递增" > -->
		                        <span id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>50万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
		                
		                <dl class="clearfix infoDl dlSec"  id="select_issecond">
		                	<dt class="w35 l-float">附加恶性肿瘤二次赔付</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_issecond" style="padding-right: 0.75rem;" data-id = 'null'>投保</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
		                
		                <dl class="clearfix infoDl dlSec"  id="select_huomian" style="display:none">
		                	<dt class="w35 l-float">附加投保人豁免</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_huomian" style="padding-right: 0.75rem;" data-id = 'null'>投保</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >156.50</span><span>元/年起</span>
				            <input type="hidden" value = '156.50' id = 'insurePrice_trans'>
			            </dt>
    ...
    $(function () 
    {
		...
		function showprem()
		{
			...
			if($("#show_huomian").attr("data-id")!='null')
			{
				ishuomian = $("#show_huomian").attr("data-id");
			}
			
			if($("#show_issecond").attr("data-id")!='null')
			{
				issecond = $("#show_issecond").attr("data-id");
			}
...
//			   	console.log(obj);
    	...
    	var show_huomian = document.querySelector('#show_huomian');
    	var select_huomian = document.querySelector('#select_huomian');
    	
    	show_huomian.addEventListener('click', function () 
		{
            var bankId = show_huomian.dataset['id'];
            var bankName = show_huomian.dataset['value'];
            var bankSelect = new IosSelect(1, 
	                [data_huomian],
	                {
	                    container: '.container',
	                    ...
	                    oneLevelId: bankId,
	                    callback: function (selectOneObj) {
	                    	select_huomian.value = selectOneObj.id;
	                    	show_huomian.innerHTML = selectOneObj.value;
	                    	show_huomian.dataset['id'] = selectOneObj.id;
	                    	show_huomian.dataset['value'] = selectOneObj.value;
    	...
    	var show_issecond = document.querySelector('#show_issecond');
    	var select_issecond = document.querySelector('#select_issecond');
    	
    	show_issecond.addEventListener('click', function () 
		{
            var bankId = show_issecond.dataset['id'];
            var bankName = show_issecond.dataset['value'];
            var bankSelect = new IosSelect(1, 
	                [data_issecond],
	                {
	                    container: '.container',
	                    ...
	                    oneLevelId: bankId,
	                    callback: function (selectOneObj) {
	                    	select_issecond.value = selectOneObj.id;
	                    	show_issecond.innerHTML = selectOneObj.value;
	                    	show_issecond.dataset['id'] = selectOneObj.id;
	                    	show_issecond.dataset['value'] = selectOneObj.value;
	...
	<script>
        ...
        {
        	//window.location.href = "./toldinfo.do?riskCode=110058";
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=110058&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem+"&ishuomian="+ishuomian+"&issecond="+issecond;
        	}
		});
	</script>
	<script>
