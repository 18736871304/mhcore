...
<html>
	<head>
		...
		<!-- <title>美华保险</title> -->
		<link rel="stylesheet" href="../../css/activity/0003/css.css?v=20191025" />
				...
				sendRequest("../../life/activity/getChannelData.do",transdata,function (data) 
				{
					var obj = JSON.parse(data);
				   	...
				   	if(obj.code == '00')
				   	{
						...
						meteor.track('form', {convert_id: '1643623806454796' });
				   	}
				   	else
				   	{
	...
	<body>
		...
		<img src="../../images/activity/0003/bao_01.jpg" width="100%" height="28%"/>
		<img id="clickmd" src="../../images/activity/0003/bao_02.jpg" width="100%" height="28%"/>
		...
		<img style="width:100%;height:auto;" src="../../images/activity/0003/bao_06.jpg"/>
		<img style="width:100%;height:auto;" src="../../images/activity/0003/bao_03.jpg"/>
		<img style="width:100%;height: 450%;" src="../../images/activity/0003/bao_04.jpg"/>
		<img style="width:100%;height: 450%;" src="../../images/activity/0003/bao_02.jpg"/>
	...
	<img style="width:100%;height: 180%;" src="../../images/activity/0003/bao_05.jpg"/>		
