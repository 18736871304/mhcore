...
<body style="">
    ...
    <article class="info">
        <form id="formId" name="formName" method="post">
            ...
            <input type="hidden" class="personInfo" id="productNo" name="orderProduct.productCode" value="34010">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	...
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow pr" style="box-sizing: border-box;">
						    ...
						    placeholder="10元起,10的倍数递增"  style="text-overflow: unset;width: 100%;" onblur="yJamntBlur(this)">
						</dd>
				        <span class="errorMsg"></span>
			        </dl>
			       <%--  <dl class="clearfix borBot1 dlSec">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
              	<dl class="clearfix infoDl borBot1 dlSec">
                    ...
                    <dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                  	    <input type="text" class="textfield txtR personInfo" id="policyName" name="applicant.appntName" value="" placeholder="请输入投保人姓名">
                    </dd>
                        <span class="errorMsg"></span>
                </dl>
                <dl class="clearfix infoDl borBot1 dlSec">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yjwn/productSpecification.pdf">《产品说明书》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yjwn/disclosure.pdf">《产品信息披露表》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/insureNote_wangxiao.pdf">《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yjwn/insuranceClauses.pdf">《保险条款》</a>
