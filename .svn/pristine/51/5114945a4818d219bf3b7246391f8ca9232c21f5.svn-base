	...
	<table class="common">
		<tr>
			...
			<td class="report_common">
				<input class="easyui-datebox" style="width: 160%" id="qrenewStartDate" name="qrenewStartDate"
					notnull="应收起期">
			</td>
			<td class="reprot_title">
				应收止期
			...
			<td class="report_common">
				<input class="easyui-datebox" style="width: 160%" id="qrenewEndDate" name="qrenewEndDate"
					notnull="应收止期">
			</td>
			<td class="reprot_title">
				保单号
		...
		<tr>
			...
			<td class="report_common">
				<select class="easyui-combobox" style="width:160%" panelHeight="auto" name="qriskchannel"
					id="qriskchannel">
				</select>
			</td>
			...
			<td class="report_common">
				<input class="easyui-combobox" id="qinsorgancode" style="width:160%" name="qinsorgancode"
			...
			<td class="report_common">
				<input class="easyui-combobox" id="qriskcode" style="width:160%" name="qriskcode"
					data-options="valueField:'id',textField:'text',multiple:true,panelHeight:'auto'">
			</td>
		...
		<tr>
			...
			<td class="report_common">
				<input class="txt" name="qreuserid" id="qreuserid" readonly
					onclick="disuUserDlg($('#qreuserid'),$('#qresuerkey'));">
			...
			<td class="report_common">
				<input class="txt" name="qseruserid" id="qseruserid" readonly
					onclick="disuUserDlg($('#qseruserid'),$('#qseruserkey'));">
			...
			<td class="report_common">
				<select class="easyui-combobox" style="width:160%" panelHeight="auto" name="qrenew_callbacktype"
					id="qrenew_callbacktype">
				</select>
			</td>
		</tr>
