...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/anbang/jquery-1.10.1.min.js"></script>
    <script src=" ../../js/anbang/mobiscroll-2.13.2.full.min.js" type="text/javascript"></script>
    <script src=" ../../js/anbang/iscroll.js" type="text/javascript"></script>
    <script src=" ../../js/anbang/iosSelect.js" type="text/javascript"></script>
    <script src=" ../../js/anbang/checkFn.js"></script>
    <script src=" ../../js/anbang/insuranceInformation.js"></script>
...
<body style="">
    <header class="header w100 pl bgColor">
        <span>和谐健康久久终身(定期)疾病保险</span>
        <br />
        <span>本产品由和谐健康保险股份有限公司承保</span>
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="hidden" class="personInfo" id="productNo" name="orderProduct.productCode" value="risk01">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow">
						    <input id = "amnt" type="text" value = "${amnt}" 
						    class="only txtR iFactor getPrice numInput import" 
						    placeholder="50000起,1000元整数倍递增"  style="text-overflow: unset;width: 100%;">
						</dd>
                 ...
                 <dl class="clearfix infoDl borBot1 dlSec">
                        ...
                        <dd class="w65 l-float txtR hasArrow">
                            <select id="appntOccupation3" class="appntOccupation txtR personInfo dw-hsel" tabindex="-1">
                                ...
                                <option value="1020202">企业经理</option>
                        		<option value="8010104">家庭主妇</option>
                        		<option value="2020906">一般工程科技技术人员</option>
                        		<option value="2090101">一般大中小学教师</option>
                        		<option value="2070501">金融一般内勤人员</option>
                        		<option value="8010102">无固定职业人员</option>
                        		<option value="2050102">医护人员</option>
                        		<option value="3010101">单位文职内勤</option>
                        		<option value="3010102">外勤商旅餐饮</option>
                        		<option value="6230608">农牧钢塑装潢</option>
                        		<option value="5030206">渔港采砂水泥</option>
                        		<option value="6240103">自用客货车、出租车司机</option>
                        		<option value="2090115">学龄前儿童</option>
                        		<option value="2090114">一般学生</option>
                        	</select>
                            <i class="arrow"></i>
                        </dd>
                            <span class="errorMsg"></span>
                    ...
                    <div class="insured" style="display: none;">
                        ...
                        <dl class="clearfix infoDl borBot1 dlSec">
                            ...
                            <dd class="w65 l-float txtR hasArrow">
                                ...
                                <input type="text" class="chosen txtR pr" readonly="" placeholder="请选择" id="insuredArea" value="">
...
<!--责任信息-->
            <section class="infoList" id="guarantee">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
	               ...
	               <!--  <dl class="clearfix borBot1 dlSec">
	                    <dt class="w65 l-float">特定心脑血管疾病保险金</dt>
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010114" name="duty_3101010114" id="duty_3101010114" data-code="3101010114" data-value="0" data-ispremcal="N" data-prem="">200%保额</textarea>
						</dd>
                        <span class="errorMsg"></span>
	                </dl>
	                <dl class="clearfix borBot1 dlSec">
	               ...
	               <!--  <dl class="clearfix borBot1 dlSec">
	                    <dt class="w65 l-float">癌症保险金</dt>
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010113" name="duty_3101010113" id="duty_3101010113" data-code="3101010113" data-value="0" data-ispremcal="N" data-prem="">200%保额</textarea>
						</dd>
                        <span class="errorMsg"></span>
	                </dl> -->
	            </div>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span>我已查看并同意<a href="<%=request.getContextPath()%>/contract/ab/risk01/notice.html">《投保须知》</a>和
		            <a id = "LifetimeOrRegularasis01" href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/ab_customerNotification.pdf">《客户告知书》</a></span>
		        </div>
		    </section>
        </form>
        <!--投保按钮-->
        <div class="pl bgColor fixedBox w100">
            <dl class="clearfix infoDl w100">
				<dt class="w55 l-float font16" style="padding-left: 3rem;position: relative;box-sizing: border-box;">
