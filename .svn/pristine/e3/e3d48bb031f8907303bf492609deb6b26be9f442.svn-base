...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/hengqin/checkFn.js?v=20201027_01"></script>
    ...
    <script>
        ...
        $(function () 
        {
        	...
        	if(iszjyl!=null&&iszjyl!="")
            {
            	$("#iszjyl").val(iszjyl);
            	$("#iszjyl_dummy").val($("#iszjyl").find("option:selected").text());
            }
    		
    		if(isexzl!=null&&isexzl!="")
            {
            	$("#isexzl").val(isexzl);
            	$("#isexzl_dummy").val($("#isexzl").find("option:selected").text());
            }
    		
    		if(isdbbjb!=null&&isdbbjb!="")
            {
            	$("#isdbbjb").val(isdbbjb);
            	$("#isdbbjb_dummy").val($("#isdbbjb").find("option:selected").text());
            }
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="511505">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="511505">
            ...
            <input type="text" style="display:none" class="personInfo" id="zjylPrice" value="0">
            <input type="text" style="display:none" class="personInfo" id="exzlPrice" value="0">
            <input type="text" style="display:none" class="personInfo" id="dbbjbPrice" value="0">
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w60 l-float txtR pr hasArrow">
			                <select id = "iszjyl" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w60 l-float txtR pr hasArrow">
			                <select id = "isexzl" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
								<option value="Y">投保</option>
						        <option value="N">不投保</option>
				            </select>
			                <i class="arrow"></i>
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w60 l-float txtR pr hasArrow">
			                <select id = "isdbbjb" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
								<option value="Y">投保</option>
						        <option value="N">不投保</option>
				            </select>
			                <i class="arrow"></i>
                	...
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w60 l-float txtR hasArrow" style="box-sizing: border-box;">
 ...
 <!--投保人信息-->
            <section class="infoList">
                ...
                <dl class="clearfix infoDl borBot1 dlSec ">
                    ...
                    <dd class="w60 l-float txtR" style="box-sizing: border-box;">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
			            <a href="<%=request.getContextPath()%>/contract/hongkang/511505.pdf" >《弘康多倍保重大疾病保险条款》</a>
			            <a href="<%=request.getContextPath()%>/contract/hongkang/521506.pdf" >《弘康重大疾病医疗保险条款》</a>
			            <a href="<%=request.getContextPath()%>/contract/hongkang/hongkang000002.pdf" >《弘康附加恶性肿瘤疾病保险条款》</a>
			            <a href="<%=request.getContextPath()%>/contract/hongkang/hongkang000024.pdf" >《弘康附加多倍保疾病保险条款》</a>
