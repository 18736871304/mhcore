	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/anxin/lnrywx/lnrywx_01.png"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">50-80周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">1年</span></p>
					<p><span class="left">最高保额</span><span class="right">30万元</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anxin/lnrywx/lnrywx_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/lnrywx/lnrywx_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/lnrywx/lnrywx_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anxin/axys/lipeiliucheng.pdf"></a>
						<a href="../../contract/anxin/lnrywx/insuranceClauses.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anxin/lnrywx/lnrywx_05.png" alt="">
				</div>
			</div>
	                ...
	                <div class="infoSec pl pr bgColor borTop1">
	                	<dl class="clearfix infoDl borBot1 dlSec"  id = "select_amnt">
		                	...
		                	<dd class="w35 l-float txtR hasArrow">
		                        <span  id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>30万元</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                	<dl class="clearfix infoDl borBot1 dlSec"  id="selectDate" style="display: none;">
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >100.00</span><span>元/年起</span>
				            <input type="hidden" value = '100.00' id = 'insurePrice_trans'>
		            	</dt>
...
//			   	console.log(obj);
    	...
    	/* 保险套餐 */
		var data_amnt = [
			{'id': '333000', 'value': '30万元'},
			{'id': '222000', 'value': '20万元'},
			{'id': '111000', 'value': '10万元'},
			{'id': '56000', 'value': '5万元'}
		];
	...
	<script>
        ...
        {	
        	...
        	{ 
    			...
    			window.location.href = "../../life/anxin/nc_ax_lnrywx.do?prem="+prem+"&amnt="+amnt
        		}
		});
	</script>
	<script>
