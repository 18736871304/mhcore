...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>投保信息</title>
    <link rel="stylesheet" href="../../css/hengqin/infos.css?v=20180505">
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="hidden" class="personInfo" id="productNo" name="orderProduct.productCode" value="ypyj">
            <input type="hidden" class="personInfo" id="insOrganCode" value="hengqin">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	...
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow">
						    ...
						    placeholder="5000起,1000元整数倍递增"  style="text-overflow: unset;width: 100%;" onblur="amntBlur(this)">
						</dd>
				        <span class="errorMsg"></span>
			        </dl>
			        <dl class="clearfix borBot1 dlSec">
            ...
            <section class="infoList">
                ...
                <dl class="clearfix infoDl borBot1 dlSec">
                	...
                	<dd class="w65 l-float txtR hasArrow">
                      ...
                      <span class="errorMsg" style=""></span>
                </dl>
                <dl class="clearfix infoDl borBot1 dlSec">
                        ...
                        <dl class="clearfix infoDl borTop1 dlSec">
                            ...
                            <dd class="w65 l-float txtR hasArrow">
                                ...
                                <select id="relation" name="insuredList[0].relationShip" class="cardType txtR personInfo getPrice dw-hsel" tabindex="-1">
                                    ...
                                    <option value="04">祖孙</option>
                                    <option value="05">监护</option>
                                    <option value="06">其他</option>
                                    <option value="07">保单服务人员</option>
                                    <option value="08">直系亲属</option>
                                </select> 
                                    <i class="arrow"></i>
                            </dd>
                                <span class="errorMsg"></span>
...
<!--责任信息-->
     <!--        <section class="infoList" id="guarantee">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
	                ...
	                <dl class="clearfix borBot1 dlSec">
	                    <dt class="w65 l-float">护理关爱保险金</dt>
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010117" name="duty_3101010117" id="duty_3101010117" data-code="3101010117" data-value="0" data-ispremcal="N" data-prem="">100%保额</textarea>
						</dd>
                        <span class="errorMsg"></span>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意<a href="<%=request.getContextPath()%>/contract/ab/risk02/notice.html">《投保须知》</a>和<a id="LifetimeOrRegularasis" href="<%=request.getContextPath()%>/contract/ab/risk02/productDetail.html" >《客户告知书》</a></span>
		        </div>
		    </section>
        </form>
        <!--投保按钮-->
