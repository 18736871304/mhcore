...
<head>
	...
	<link rel="stylesheet" href="../../css/hengqin/index.css?v=20191120">
	<link rel="stylesheet" href="../../css/hengqin/iosSelect.css?v=20191120">
	<script src=" ../../js/hengqin/jquery-1.10.1.min.js?v=20191120"></script>
	<script src="http://res.wx.qq.com/open/js/jweixin-1.2.0.js?v=20191120"></script>
    <script src=" ../../js/hengqin/iscroll.js?v=20191120" type="text/javascript"></script>
    <script src=" ../../js/hengqin/iosSelect_2.js?v=20191120" type="text/javascript"></script>
    <script src=" ../../js/hengqin/areaData_v2.js?v=20191120"></script>
    <script src=" ../../js/hengqin/zepto.js?v=20191120"></script>
    <script src=" ../../js/hengqin/sjMain.js?v=20191120"></script>
    <style>
		.recommend_wrapper{
			position: absolute;
			left: 0;
...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hongkang/bbjzj/hkbbj_01.png?v=20191120"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-50周岁</span></p>
					<p><span class="left">保障期限</span><span class="right">70岁/终身</span></p>
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_02.png?v=20191120" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_03.png?v=20191120" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_04.png?v=20191120" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/bbjzj/hkbbj_05.jpg?v=20191120" alt="">
				</div>
			</div>
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_amnt" style="padding-right: 0.75rem;" data-id = 'null'>100万</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_JFTime">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_JFTime" style="padding-right: 0.75rem;" data-id = 'null'>30年</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
		                ...
		                <dl class="clearfix infoDl dlSec"  id="select_abzkx">
		                	<dt class="w35 l-float">恶性肿瘤复发和持续保险金</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span id="show_abzkx" style="padding-right: 0.75rem;" data-id = 'null'>投保</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
	                </div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >6440.00</span><span>元/年起</span>
				            <input type="hidden" value = '6440.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script type="text/javascript">
		...
		function showprem()
		{
			...
			if($("#show_abzkx").attr("data-id")!='null')
			{
				isabzkx = $("#show_abzkx").attr("data-id");
			}
			
			var premdata = 
			{
				"insorgancode":'hongkang',
				"riskcode":'hongkang000015',
				"age":age,
				"sex":sex,
				"amnt":amnt,
...
//			   	console.log(obj);
    	...
    	var show_abzkx = document.querySelector('#show_abzkx');
    	var select_abzkx = document.querySelector('#select_abzkx');
    	
    	show_abzkx.addEventListener('click', function () 
		{
            var bankId = show_abzkx.dataset['id'];
            var bankName = show_abzkx.dataset['value'];
            var bankSelect = new IosSelect(1, 
	                [data_abzkx],
	                {
	                    container: '.container',
	                    ...
	                    oneLevelId: bankId,
	                    callback: function (selectOneObj) {
	                    	select_abzkx.value = selectOneObj.id;
	                    	show_abzkx.innerHTML = selectOneObj.value;
	                    	show_abzkx.dataset['id'] = selectOneObj.id;
	                    	show_abzkx.dataset['value'] = selectOneObj.value;
	...
	<script>
        $('.footer_go').click(function()
        {
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=hongkang000015"
