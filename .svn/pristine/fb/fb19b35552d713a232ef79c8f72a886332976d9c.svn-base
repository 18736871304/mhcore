...
{
	window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx37a5a6ceced4f359&redirect_uri=http://insure.meihualife.com/life/activity/oneyuangotest.do&response_type=code&scope=snsapi_base&state=hd_pay#wechat_redirect";
}
else
{
	var jsstr = ${jsstr};
