...
<head>
	...
	<script>
		...
		function FileUpload()
		{
			ajaxFileUpload('filename','/policy/policyImport.do',null,null,null,saveSuss);
			//上传完毕之后，把浏览框中的文本清除。
		}
	</script>
</head>
...
<body>
	<div style="margin-left:0%">
		...
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" id="articlequery"
			...
			<a href="/upload/policymodify.xls" class="easyui-linkbutton" data-options="iconCls:'icon-search'"
