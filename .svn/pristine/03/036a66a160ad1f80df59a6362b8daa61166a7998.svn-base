...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="110049">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="110049">
            ...
            <input type="text" style="display:none" class="personInfo" id="ysduty1" value="0">
            <input type="text" style="display:none" class="personInfo" id="ysduty2" value="0">
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        <dl class="clearfix borBot1 dlSec">
				        <dt class="w35 l-float">是否自动续保</dt>
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "autopayflag" class="premium txtR iFactor getPrice PaymentDeadline dw-hsel" tabindex="-1">
			        ...
			        <dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow">
						    <select id = "zlamnt" class="premium txtR iFactor getPrice PaymentDeadline dw-hsel" tabindex="-1">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110049/110049-tk.pdf">《保险条款》</a>
