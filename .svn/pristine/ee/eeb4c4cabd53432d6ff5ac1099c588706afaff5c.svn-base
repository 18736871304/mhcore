...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/jklife/8222/8222_01.png"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/jklife/8222/8222_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/jklife/8222/8222_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/jklife/8222/8222_04.png" alt="">
					<!-- 
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/jklife/8222/8222_05.png" alt="">
				</div>
			</div>
			...
			<div class="pl bgColor fixedBox w100 hq-productBottom" style="display:none">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >784.00</span><span>元/年起</span>
				            <input type="hidden" value = '784.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'8222','jklife');
	   })
