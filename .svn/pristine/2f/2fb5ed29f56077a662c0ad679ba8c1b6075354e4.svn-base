<%@ page contentType="text/html;charset=utf-8" %>
	...
	<script>
		...
		function dispolicyDetailDlg(rowdata, disappphone) {
			...
			$('#dlgappmaritalstatus').val(rowdata.appmaritalstatus);
		...
		function disInsured(row) {
			...
			if (row.queryinsured == 'Y') {
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人证件类型</td><td class = "common"><input class = "txt" readonly name="dlginsidnotype" id="dlginsidnotype" value = "' + row.insidnotype + '"></td></tr>';
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人婚否</td><td class = "common"><input class = "txt" readonly name="dlginsmaritalstatus" id="dlginsmaritalstatus" value = "' + row.insmaritalstatus + '"></td></tr>';
		...
		function dealInsuredList(data) {
			...
			for (var i = 0; i < data.insuredList.length; i++) {
				...
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人体重</td><td class = "common"><input class = "txt" readonly name="dlginsweight" id="dlginsweight" value = "' + getQueryData(data.insuredList[i].insweight) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人婚否</td><td class = "common"><input class = "txt" readonly name="dlginsmaritalstatus" id="dlginsmaritalstatus" value = "' + getQueryData(data.insuredList[i].insmaritalstatus) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人职业</td><td class = "common"><input class = "txt" readonly name="dlginsjobcode" id="dlginsjobcode" value = "' + getQueryData(data.insuredList[i].insjobcode) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人年收入</td><td class = "common"><input class = "txt" readonly name="dlginssalary" id="dlginssalary" value = "' + getQueryData(data.insuredList[i].inssalary) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否有医保</td><td class = "common"><input class = "txt" readonly name="dlghaveMedical" id="dlghaveMedical" value = "' + getQueryData(data.insuredList[i].haveMedical) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人是否吸烟</td><td class = "common"><input class = "txt" readonly name="dlgissmoke" id="dlgissmoke" value = "' + getQueryData(data.insuredList[i].issmoke) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人手机号码</td><td class = "common"><input class = "txt" readonly name="dlginsphone" id="dlginsphone" value = "' + getQueryData(data.insuredList[i].insphone) + '"></td></tr>';
				insuredHtml = insuredHtml + '<tr><td class = "regittitle">被保人电子邮箱</td><td class = "common"><input class = "txt" readonly name="dlginsemail" id="dlginsemail" value = "' + getQueryData(data.insuredList[i].insemail) + '"></td></tr>';
