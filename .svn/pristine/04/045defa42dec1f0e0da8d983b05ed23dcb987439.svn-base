...
{
	var tturl = "CIRC/getriskcategoryPrem.do";
...
<div style="margin-left:0%">
	<table class = "common">
		<!-- <tr>
			...
			<td class = "common">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="riskcatagoryOne" id="riskcatagoryOne" notnull = "保险大类">
				</select>
			</td>
			...
			<td class = "common">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="riskcatagoryTwo" id="riskcatagoryTwo" notnull = "保险二类">
				</select>
			</td>
			...
			<td class = "common">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="riskcatagoryThree" id="riskcatagoryThree" notnull = "保险三类">
				</select>
			</td>
			...
			<td class = "common">
				<select class = "easyui-combobox" style="width:160%" panelHeight="auto" panelWidth="200" name="qriskcode" id="qriskcode" notnull = "险种">
				</select>
			</td>
			<td class = "title">
				保单状态
	...
	<table id="riskcategoryPrem" class="easyui-datagrid" title="保单信息" style="width:auto;height:auto"
		...
		<thead>
			<tr>
				<th data-options="field:'categoryname',width:150">名称</th>
