...
<body style="">
    ...
    <article class="info">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="07P002_axes2">
            <input type="text" style="display:none" class="personInfo" id="aliasname" value="axes2">
 ...
 <!--受益人信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/declarationsConfirmA.pdf">《A款投保声明》</a>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/declarationsConfirmB.pdf">《B款投保声明》</a><br/>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/insurancePolicyA.pdf">《投保须知（安心综合医疗保险（A款））》</a><br/>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/insurancePolicyB.pdf">《投保须知（安心综合医疗保险（B款））》</a><br/>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/insuranceClausesA.pdf">《安心综合医疗保险条款（2017版）（A款）》</a><br/>
		            <a href="<%=request.getContextPath()%>/contract/anxin/axys2/insuranceClausesB.pdf">《安心综合医疗保险条款（2017版）（B款）》</a>
