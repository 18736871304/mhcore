...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/hongkang/411302/411302_01.png"  alt="">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hongkang/411302/411302_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hongkang/411302/411302_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hongkang/411302/411302_04.png" alt="">
				...
				<div id="nav4" class="product_desc">
					<img src="../../images/hongkang/411302/411302_05.png" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'411302','hongkang');
	   })
