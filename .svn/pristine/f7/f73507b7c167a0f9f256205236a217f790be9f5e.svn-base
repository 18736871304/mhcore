...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script>
        ...
        $(function () 
        {
        	...
        	if(issecond!=null&&issecond!="")
        	{
        		$("#issecond").val(issecond);
        		$("#issecond_dummy").val($("#issecond").find("option:selected").text());
        	}
...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" value="110058">
            <input type="text" style="display:none" class="personInfo" id="riskcode" value="110058">
            <input type="text" style="display:none" class="personInfo" id="hmriskcode" value="120015">
            <input type="text" style="display:none" class="personInfo" id="zlriskcode" value="">
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            ...
			            <dd class="w65 l-float txtR hasArrow">
			                <select id = "issecond" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110058/110058-tk.pdf">《康乐一生(2019)条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110058/120015-tk.pdf" id="hmtk">《附加投保人豁免条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/fuxinglhjk/110058/110058-tbxz.pdf?v=20190508">《投保须知》</a>
