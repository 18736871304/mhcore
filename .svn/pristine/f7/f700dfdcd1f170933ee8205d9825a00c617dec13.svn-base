...
function calPrice1() {
    ...
    if ($("#relation").find("option:selected").val() == '00') {
        ...
        transData = {
            ...
            "d_7F9": $("#zdjb").find("option:selected").val(),
            "d_7G6": $("#zjzyjt").find("option:selected").val(),
            "d_7G7": $("#txyl").find("option:selected").val(),
            "d_7G8": $("#hwyl").find("option:selected").val(),
            "mpehm": familympehm
        }
    } else {
...
function getData() {
    ...
    // '"sumprem":"",'
    // ,"productCode":"' + productCode + '","packageCode":"' + productCode + '"
    ...
    jsonStr = jsonStr + '{"insrealtion":"' + insrealtion + '","insname":"' + $("#insuredName").val() + '","inscardno":"' + $("#insuredIdNo").val() + '","inscardtype":"0",' +
        ...
        '"age":"' + insage  + '","packageCode":"' + productCode + '"},'
