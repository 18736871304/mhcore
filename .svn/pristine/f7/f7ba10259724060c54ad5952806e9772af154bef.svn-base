...
<body>
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/taipy/laolf/llfnjx_01.png"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-65周岁</span></p>
					<p><span class="left">保障期间</span><span class="right">终身</span></p>
					<p><span class="left">缴费方式</span><span class="right">15/20年交</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/taipy/laolf/llfnjx_02.png" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/taipy/laolf/llfnjx_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/taipy/laolf/llfnjx_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="javascript:;"></a>
						<a href="../../contract/taipy/laolf/laolf.pdf"></a>
						<a href="javascript:;"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/taipy/laolf/llfnjx_05.png" alt="">
				</div>
			</div>
			<!-- <div class="recommend_wrapper">
	...
	<script>
	   ...
	   $('.confirm-btn').on('click',function()
	   {
		   ...
		   intentionInsert(mobile,'13D00080','taipy');
	   })
	...
	wx.ready(function () {	//朋友圈
	   	wx.onMenuShareTimeline({
	        title: '老来福年金险', // 分享标题
	        link: 'http://insure.meihualife.com/life/taipy/dis_taipy_01.do?reuserid='+reuserid, // 分享链接
	        imgUrl: 'http://insure.meihualife.com/images/taipy/laolf/llfnjx_wx.png',
