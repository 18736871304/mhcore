	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/anxin/bwylPlus/axeswybwylx_01.png"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">6-45周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">1年</span></p>
					<p><span class="left">最高保额</span><span class="right">100万</span></p>
				</div>
			</div>
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/anxin/bwylPlus/axeswybwylx_02.jpg" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/bwylPlus/axeswybwylx_03.png" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/bwylPlus/axeswybwylx_04.png" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/anxin/axys/lipeiliucheng.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/insuranceClauses.pdf"></a>
						<a href="../../contract/anxin/bwylPlus/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/anxin/bwylPlus/axeswybwylx_05.png" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >884.00</span><span>元/年起</span>
				            <input type="hidden" value = '884.00' id = 'insurePrice_trans'>
		            	</dt>
	...
	<script>
        ...
        {	
        	...
        	{ 
        		...
        		window.location.href = "./toldinfo.do?aliasname=bwylPlus&socialInsuFlag="+socialInsuFlag+"&prem="+prem;
        		}
		});
	</script>
	<script>
