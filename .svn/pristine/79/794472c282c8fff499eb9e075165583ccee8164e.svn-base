		...
		<div class="main_wrapper">
			<div class="banner_wrapper">
				...
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">18周岁-60周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">20/30年</span></p>
			...
			<div class="product_wrapper">
				...
				<div id="nav3" class="product_desc">
					...
					<div class="recommend_wrapper">
						...
						<a href="../../contract/hezhong/acx/acx_laxtiaokuan.pdf"></a>
						<a href="../../contract/hezhong/acx/acx_xxpl.pdf"></a>
					</div>
				</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >1320.00</span><span>元/年起</span>
				            <input type="hidden" value = '1320.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=636&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem;
        	}	
		});
	</script>
	<script>
