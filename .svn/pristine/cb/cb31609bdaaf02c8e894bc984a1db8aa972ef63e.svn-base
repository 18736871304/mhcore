...
<body>
		                ...
		                <dl class="clearfix infoDl borBot1 dlSec"  id="select_amnt">
		                	...
		                	<dd class="w65 l-float hasArrow">
		                        <input id = "amnt" type="number" style="padding-right: 0.75rem;"
		                        	onchange = "showprem();" placeholder="50000起,1000元整数倍递增">
		                    </dd>
		                </dl>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
						<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
						    ...
						    <span readonly="" class="insurePrice" id="insurePrice" >595.00</span><span>元/年起</span>
				            <input type="hidden" value = '595.00' id = 'insurePrice_trans'>
			            </dt>
    ...
    */
	...
	function showprem()
	{
		...
		sendPriceRequest("../../life/ab/getprice02.do",premdata,function (data) 
		{
    ...
    $('.footer_go').click(function()
    {
    	...
    	else
    	{
    		...
    		window.location.href = "../../life/ab/toldinfo.do?riskCode=2140152&payendyear="+payendyear+"&amnt="+amnt+"&prem="+prem+"&ishuomian="+ishuomian;
    	}
	});
	</script>
	<script>
