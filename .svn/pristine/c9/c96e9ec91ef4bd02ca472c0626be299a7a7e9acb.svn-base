...
{
	var tturl = "policy/getUserintentionList.do";
...
function intentionedit()
{
	...
	ajaxdeal("policy/intentionUserChange.do",tparam,null,null,saveSuss);
	userintentionquery();
}
...
<div style="margin-left:0%">
	...
	<table class = "common">
		<tr>
			...
			<td class = "common">
				<input class = "txt" readonly="readonly" name="reuserid" id="reuserid" notnull = "分配给业务员" onclick = "disuUserDlg($('#reuserid'));">
			</td>
			<!-- <td class = "title">
				姓名
			</td>
