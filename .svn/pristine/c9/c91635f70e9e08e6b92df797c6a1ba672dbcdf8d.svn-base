...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/hengqin/jquery-1.10.1.min.js?v=20180422"></script>
    ...
    <script src=" ../../js/sunlife/insuranceInformation.js?v=20180504"></script>
    ...
    var prem = '${prem}';
        ...
        $(function () {
        	...
        	{
        		$("#insureplan").val(plan);
        		$("#insureplan_dummy").val($("#insureplan").find("option:selected").text());
        	}
        	
        	if(ishuanmian!=null&&ishuanmian!="")
        	{
        		$("#ishuanmian").val(huomian);
        		$("#ishuanmian_dummy").val($("#ishuanmian").find("option:selected").text());
        	}
        	
        	if(prem!=null&&prem!="")
        	{
        		$("#insurePrice").html(prem);	
        	}
...
<body style="">
    <header class="header w100 pl bgColor">
        <span>i保终身重大疾病险</span>
        <br/>
        <span>本产品由阳光人寿保险有限公司承保</span>
        
        <img src="../../images/logo/sunlife_typein.png?v=2018061602" />
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="hidden" class="personInfo" id="productNo" name="orderProduct.productCode" value="ibao">
            <input type="hidden" class="personInfo" id="insOrganCode" value="sunlife">
            <input type="hidden" class="personInfo" id="mainPrice">
            <input type="hidden" class="personInfo" id="hmPrice">
            <input type="hidden" class="personInfo" id="qzPrice">
            <input type="hidden" class="personInfo" id="sumPrice">
            ...
            <section class="infoList product">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
                	...
                	<dl class="clearfix borBot1 dlSec" style="display:none;">
			            <dt class="w35 l-float">保险方案</dt>
			            <dd class="w65 l-float txtR hasArrow">
			                <select id = "insureplan" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
						        <option value="02">Plus款</option>
				            </select>
			                <i class="arrow"></i>
						</dd>
                	...
                	<dl class="clearfix borBot1 dlSec">
						...
						<dd class="w65 l-float txtR hasArrow">
						    <select id = "amnt" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
					...
					<dl class="clearfix borBot1 dlSec" style="display: none;">
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "insuyear" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
								...
								<option value="80A">80周岁</option>
								<option value="75A">75周岁</option>
								<option value="70A">70周岁</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			            <span class="errorMsg"></span>
			        ...
			        <dl class="clearfix borBot1 dlSec">
			            <dt class="w35 l-float">附加险</dt>
			            <dd class="w65 l-float txtR hasArrow">
			                <select id = "ishuanmian" class="premium txtR iFactor getPrice dw-hsel" tabindex="-1">
						        <option value="00">不投保</option>
						        <option value="01">轻症</option>
						        <option value="02">轻症+轻症豁免</option>
				            </select>
			                <i class="arrow"></i>
						</dd>
		                    <span class="errorMsg"></span>
                ...
                <dl class="clearfix infoDl borBot1 dlSec" style="display: none;">
                    ...
                    <dd class="w65 l-float txtR hasArrow">
                  	<span class="birthday" id="birthdayChoose" style="display: none;">
                  		<input type="text" class="textfield txtR personInfo birthdayChoose" readonly="" id="birthday" name="applicant.appntBirthday" value="" placeholder="请选择">
                   		<i class="arrow"></i>
                    </span>
                        <input type="text" class="textfield txtR birthdayReadonly personInfo" readonly="" value="">
                    </dd>
                        <span class="errorMsg"></span>
                </dl>
                <dl class="clearfix infoDl borBot1 dlSec" style="display: none;">
                 ...
                 <dl class="clearfix infoDl borBot1 dlSec">
                        ...
                        <dd class="w65 l-float txtR hasArrow">
                            <select id="appntOccupation3" class="appntOccupation txtR personInfo dw-hsel" tabindex="-1">
    	                        ...
    	                        <option value="3050102">企业经理</option>
                                <option value="3050104">企业或工厂负责人</option>
                                <option value="4021106">电子工程师</option>
                                <option value="4021302">计算机软件技术人员</option>
                                <option value="4060301">会计人员</option>
                                <option value="4079901">金融业内勤人员</option>
                                <option value="4090101">高等教育教师</option>
                                <option value="4099907">一般学生</option>
                                <option value="5010101">行政业务办公人员-内勤</option>
                                <option value="5010202">公务员</option>
                                <option value="6010101">营业员</option>
                                <option value="6071203">家庭主妇</option>
                                <option value="6071506">个体经营商</option>
                                <option value="7010101">农夫</option>
                        	</select>
                            <i class="arrow"></i>
                        </dd>
                            <span class="errorMsg"></span>
                   ...
                   <dl class="clearfix infoDl borBot1 dlSec">
        				...
        				<dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
        				   <input type="number" class="textfield txtR" id="appnt_height" value="" placeholder="请输入">
        			   	</dd>
        			   	<span class="errorMsg"></span>
        	       </dl>
                   <dl class="clearfix infoDl borBot1 dlSec">
                		...
                		<dd class="w65 l-float txtR pr" style="box-sizing: border-box;">
                			<input type="number" class="textfield txtR" id="appnt_weight" value="" placeholder="请输入">
                		</dd>
                		<span class="errorMsg"></span>
                	</dl>
...
<!--被保人信息-->
            <section class="infoList" id="scrollTop" style="display:'';">
	            <p class="ml">被保人信息</p>
	            <div class="infoSec pl pr bgColor borTop1 borBot1">
...
<!--不一致时被保人信息-->
                    <div class="insured" style="display: none;">
                        ...
                        <dl class="clearfix infoDl dlSec" style="display: none;">
                            <dt class="w35 l-float">出生日期</dt>
                            <dd class="w65 l-float txtR hasArrow">
            ...
            <section class="infoList" id="guarantee">
                ...
                <div class="infoSec pl pr bgColor borTop1 borBot1">
	                ...
	                <dl class="clearfix borBot1 dlSec">
	                    ...
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010111" name="duty_3101010111" id="duty_3101010111" data-code="3101010111" data-value="0" data-ispremcal="N" data-prem="">20%保额</textarea>
						</dd>
                        <span class="errorMsg"></span>
	                </dl>
	                <dl class="clearfix borBot1 dlSec">
	                    ...
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010119" name="duty_3101010119" id="duty_3101010119" data-code="3101010119" data-value="2@3101010118@1" data-ispremcal="Y" data-prem="">豁免后期保费</textarea>
						</dd>
                        <span class="errorMsg"></span>
	                </dl>
	                <dl class="clearfix borBot1 dlSec">
	                    <dt class="w65 l-float">长期护理保费豁免</dt>
	                    <dd class="w35 l-float txtR hasArrow">
	                        <textarea readonly="" class="only textfield txtR insurInfo change_3101010119" name="duty_3101010119" id="duty_3101010119" data-code="3101010119" data-value="2@3101010118@1" data-ispremcal="Y" data-prem="">豁免后期保费</textarea>
						</dd>
                        <span class="errorMsg"></span>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span>我已查看并同意
		            <a id = "suntbinfo" href="<%=request.getContextPath()%>/contract/sunlife/tbInfo.html">《投保须知》</a>
		            <a id = "sunheath" href="<%=request.getContextPath()%>/contract/sunlife/heathnotice.pdf">《人身险投保提示书》</a>
		            <a id = "wddg" href="<%=request.getContextPath()%>/contract/sunlife/wddg.pdf">《i保plus条款》</a>
		            <a id = "wsda" href="<%=request.getContextPath()%>/contract/sunlife/wsda.pdf">《附加轻症条款》</a>
		            <a id = "wswg" href="<%=request.getContextPath()%>/contract/sunlife/wswg.pdf">《附加豁免条款》</a>
		            <a id="LifetimeOrRegularasis" href="<%=request.getContextPath()%>/contract/hengqin/taxResident.html" >《中国税收居民声明》</a>
		            <a href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/sunrs_customerNotification.pdf">《客户告知书》</a>
		            </span>
		        </div>
		    </section>
        </form>
        ...
        <div class="pl bgColor fixedBox w100">
            <dl class="clearfix infoDl w100">
				<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				    ...
				    <span readonly="" class="insurePrice" id="insurePrice" >${insurePrice}</span><span>元/年</span>
	            </dt>
