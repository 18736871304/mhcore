		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav2" class="product_desc">
					<img src="../../images/anxin/axys/axysfax_03.png?v=20181119" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/anxin/axys/axysfax_04.png?v=20181119" alt="">
	...
	<script>
        ...
        {	
        	...
        	{ 
        		...
        		window.location.href = "./toldinfo.do?aliasname=axys&prem="+prem+"&source="+$('#source').val();
        		}
		});
	</script>
	<script>
