				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >525.00</span><span>元/年起</span>
				            <input type="hidden" value = '525.00' id = 'insurePrice_trans'>
			            </dt>
	...
	<script>
        $('.footer_go').click(function()
        {
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=hongkang000015_nian"
