		...
		<div class="main_wrapper">
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_02.png?v=20180420_01" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_03.png?v=20180420_01" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_04.png?v=20180420_01" alt="">
					<div class="recommend_wrapper">
						<a href="../../contract/hengqin/lptk.pdf"></a>
						<a href="../../contract/hengqin/jxnn/insuranceClauses.pdf"></a>
						<a href="../../contract/hengqin/jxnn/disclosure.pdf"></a>
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/hengqin/jxnn/jxnn_05.png?v=20180420_01" alt="">
				</div>
			</div>
			...
			<div class="footer_wrapper" id="footer_wrapper">
				...
				<section class="infoList trialCon" style="display:none;">
	                <div class="infoSec pl pr bgColor borTop1">
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_prem">
						...
						<dl class="clearfix infoDl borBot1 dlSec"  id="select_BEMoney">
		                	...
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_BEMoney" style="padding-right: 0.75rem;" data-id = 'null'>60周岁后的首个保单周年日</span>
		                        <i class="arrow"></i>
		                    </dd>
		                </dl>
						<dl class="clearfix infoDl dlSec"  id="select_zsj">
		                	<dt class="w35 l-float">祝寿金金额</dt>
		                	<dd class="w65 l-float txtR hasArrow">
		                        <span  id="show_zsj" style="padding-right: 0.75rem;"></span>
		                    </dd>
		                </dl>
	                </div>
	            </section>   
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >1000.00</span><span>元/年起</span>
	...
	<script>
        ...
        {	
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=14040&payendyear="+payendyear+"&getyear="+getyear+"&prem="+prem
        	}	
		});
	</script>
	<script>
		...
		wx.ready(function () {	//朋友圈
	    	wx.onMenuShareTimeline({
		        title: '金禧年年年金险', // 分享标题
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_jxnn_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/jxnn/jxnn-wx.png',
		    ...
		    wx.onMenuShareAppMessage({
		        title: '金禧年年年金险', // 分享标题
		        desc: '活到老领到老，且60/65岁一次性返还100%已交保费', // 分享描述
		        link: 'http://insure.meihualife.com/life/hq/nc_hq_jxnn_01.do?reuserid='+reuserid, // 分享链接
		        imgUrl: 'http://insure.meihualife.com/images/hengqin/jxnn/jxnn-wx.png',
