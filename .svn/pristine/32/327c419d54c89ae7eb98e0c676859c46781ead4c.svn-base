$(document).ready(function() {
    ...
    $(".coincidence").click(function(){
    	//alert($("#orderNo").val());
    	sendRequest("../../life/ab/toldinfo_save.do",{"orderNo":$("#orderNo").val()},function(data)
    	{
    		var obj = JSON.parse(data);
    		console.log(obj);
        	if(obj.code == 0)
        	{
        		if($("#riskcode").val()=="2140152")
        		{
        			window.location.href = "../../life/ab/newcontract02.do?payendyear="+$("#payendyear").val()
