	...
	<div class="index_wrapper">
		<div class="main_wrapper">
			<div class="banner_wrapper">
				<img src="../../images/fuxinglhjk/110025/110025_01.png?v=20190321"  alt="">
				<div class="banner_desc">
					<p><span class="left">投保年龄</span><span class="right">30天-50周岁</span></p>
					<p><span class="left">保险期间</span><span class="right">70岁/80岁/终身</span></p>
			...
			<div class="product_wrapper">
				...
				<div id="nav1" class="product_desc">
					<img src="../../images/fuxinglhjk/110025/110025_02.png?v=20190321" alt="">
				</div>
				<div id="nav2" class="product_desc">
					<img src="../../images/fuxinglhjk/110025/110025_03.png?v=20190321" alt="">
				</div>
				<div id="nav3" class="product_desc">
					<img src="../../images/fuxinglhjk/110025/110025_04.png?v=20190321" alt="">
					<div class="recommend_wrapper">
					</div>
				</div>
				<div id="nav4" class="product_desc">
					<img src="../../images/fuxinglhjk/110025/110025_05.png?v=20190321" alt="">
				</div>
			</div>
				...
				<div class="pl bgColor fixedBox w100 hq-productBottom">
		            <dl class="clearfix infoDl w100">
			            <dt class="w65 l-float  font16" style="text-align:center;padding-left: 2.3rem;position: relative;">
				            ...
				            <span readonly="" class="insurePrice" id="insurePrice" >118.50</span><span>元/年起</span>
				            <input type="hidden" value = '118.50' id = 'insurePrice_trans'>
			            </dt>
...
//			   	console.log(obj);
	...
	<script>
        ...
        {
        	//window.location.href = "./toldinfo.do?riskCode=110025";
        	...
        	else
        	{
        		...
        		window.location.href = "./toldinfo.do?riskCode=110025&payendyear="+payendyear+"&insuyear="+insuyear+"&amnt="+amnt+"&prem="+prem+"&ishuomian="+ishuomian;
        	}
		});
	</script>
	<script>
