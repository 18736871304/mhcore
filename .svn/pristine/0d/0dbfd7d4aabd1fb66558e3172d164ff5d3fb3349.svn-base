...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src=" ../../js/anbang/insuranceInformation.js?v=20180504_01"></script>
...
<body style="">
    <header class="header w100 pl bgColor">
        ...
        <img src="../../images/logo/hexie_typein.png" />
    </header>
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="hidden" class="personInfo" id="productNo" name="orderProduct.productCode" value="risk02">
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意<a href="<%=request.getContextPath()%>/contract/ab/risk02/notice.html">《投保须知》</a>
		            	和<a id="LifetimeOrRegularasis" href="<%=request.getContextPath()%>/contract/common/kehugaozhishu/ab_customerNotification.pdf" >《客户告知书》</a></span>
		        </div>
		    </section>
        </form>
        <!--投保按钮-->
        <div class="pl bgColor fixedBox w100">
            <dl class="clearfix infoDl w100">
				<dt class="w65 l-float font16" style="text-align:center;padding-left: 2.3rem;position: relative;box-sizing: border-box;">
				    ...
				    <span readonly="" class="insurePrice" id="insurePrice" >595.00</span><span>元/年</span>
	            </dt>
