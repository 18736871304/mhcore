...
<head>
    ...
    <script src="../../js/hengqin/payment.js?v=2018080603"></script>
</head>
<body style="">
    ...
    <section class="infoList">
        <div class="ml whetherRead pr">
            ...
            <span>我已认真阅读
				<a href="<%=request.getContextPath()%>/contract/hengqin/payment.html">《银行转账授权声明书》</a>并同意上述协议规定。
			</span>
        </div>
    </section>
