...
function FileUpload()
{
	ajaxFileUpload('filename','/policy/yeayPayImport.do?type=month',null,null,null,saveSuss);
	//上传完毕之后，把浏览框中的文本清除。
}
...
<div style="margin-left:0%">
	...
	<a href="/upload/renewmonth.xls" class="easyui-linkbutton" data-options="iconCls:'icon-search'"
