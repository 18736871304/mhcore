...
<body style="">
    ...
    <article class="info" style="margin-top: 5.2rem;">
        <form id="formId" name="formName" method="post">
            ...
            <input type="text" style="display:none" class="personInfo" id="productNo" name="orderProduct.productCode" value="12030">
					...
					<dl class="clearfix borBot1 dlSec">
					    ...
					    <dd class="w65 l-float txtR hasArrow">
					        <select id = "insuyear" class="premium txtR iFactor getPrice PaymentDeadline dw-hsel" tabindex="-1">
								...
								<option value="60Y">保至60岁</option>
								<option value="65Y">保至65岁</option>
								<option value="70Y">保至70岁</option>
						    </select>
					        <i class="arrow"></i>
						</dd>
			            <span class="errorMsg"></span>
...
<!--续缴账户信息-->
			...
			<section class="infoList">
		        <div class="ml whetherRead">
		            ...
		            <span >我已查看并同意
		            <%-- <a href="<%=request.getContextPath()%>/contract/hengqin/ykb/disclosure.pdf">《产品信息披露表》</a> --%>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/yabdsInsuranceClauses.pdf">《保险条款》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/iInsurancePolicy_qgwangxiao.pdf">《投保须知》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/insureNote_wangxiao.pdf">《投保提示书》</a>
		            <a href="<%=request.getContextPath()%>/contract/hengqin/yab/declarationsConfirm10.pdf">《告知声明书》</a>
