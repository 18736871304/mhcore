...
<body>
	<div>
		<div class="content">
			<p>1. 您是否在其他保险公司投保寿险或者重疾险，且保额超过100万元？</p>
			<p>2. 您在其他保险公司的人身保险、健康保险投保申请或复效申请是否曾被拒保、延期、附加条件承保？或被解除过保险合同？或申请过重大疾病理赔？
				<br />矿工、海上救护及潜水人员、爆破工、采掘工、化工产品生产工人、伐木工、木材装运工、拆屋工、凿岩工、火药爆竹制造及加工工人、高压电工程作业人员、
				高空作业人员、战地记者、特技演员、动物园驯兽师、高空杂技、飞车、飞人演员、特种兵（伞兵、海军陆战队、化学兵、负有布雷爆破任务之士兵）、空中或海
				上作业人员、前线军人、消防队员、防暴警察、运动员（滑雪、散打、拳击）。
			</p>
			<p>3. 您在过去1年内是否曾发现健康检查结果异常（如血液、超声、影像、内镜、病理检查）？过去2年内是否因健康异常发生过住院或手术，或由医师给您提出进一步检查、住院或手术的建议？
			（此处所述住院治疗或手术不包含阑尾炎、急性鼻炎、急性肺炎、急性肠胃炎、顺产、剖腹产）</p>
			<p>4. 您是否目前或过去一年内曾有过下列症状？反复头痛或眩晕、晕厥、咯血、胸痛、呼吸困难、呕血、黄疸、便血、听力下降、耳鸣、复视、视力明显下降、原因不明皮肤病和粘膜及齿龈出血、
			原因不明的发热、原因不明的体重下降超过5公斤、原因不明的肌肉萎缩、原因不明的包块或肿物、身体的其他感觉异常或活动障碍。</p>
			<p>5. 您是否目前患有或过去曾经患过下列疾病或手术史？
				<br />a.脑、神经系统及精神方面疾病，例如：癫痫、脑中风、脑炎、脑膜炎、脑血管瘤、运动神经元病、阿尔茨海默氏症、帕金森氏综合症、脊髓疾病、重症肌无力、
				多发性硬化、抑郁症、精神病、脑部手术史。
				...
				<br />g.内分泌、血液系统、免疫系统疾病，例如：糖尿病、痛风、甲状腺或甲状旁腺疾病、白血病、血友病、再生障碍性贫血、地中海贫血、艾滋病或艾滋病病毒（HIV）携带。
				<br />h.五官科疾病，例如：视网膜出血或剥离、青光眼、美尼尔病、五官手术史。
				<br />i.以上未提及的肿瘤，包括：肉瘤、癌、良性肿瘤、息肉、囊肿。
				<br />j.酒精或药物、毒品滥用成瘾。
				<br />k.智能障碍，失明、聋哑及语言、咀嚼或身体其他部位缺损、残疾或功能障碍。
			</p>
			<p>6.您的亲属（父母、子女、兄弟姐妹）中是否有1位在50周岁前患有、或者有2位（含）以上患有下列疾病：癌症/恶性肿瘤、心脑血管病症、白血病、血友病、糖尿病、多囊肝、多囊肾、肠息肉、阿尔茨海默病？</p>
			<p>7. 您是否存在下列习惯？
				<br />a.吸烟，且平均每日吸烟2包以上。
			...
			<p>8. 成年女性被保险人适用: 
				<br />a.您是否正处于妊娠期？
				<br />b.您是否曾有阴道异常流血、畸胎瘤、葡萄胎、子宫颈重度不典型增生、乳腺囊肿/结节、子宫肌瘤、卵巢肿瘤？
			</p>
			<p>9. 2周岁以下被保险人适用：
				<br />a.是否为出生低体重儿（出生时体重为2.5公斤以下）或早产儿（出生孕周<37周）？出生时候是否曾有产伤、窒息等异常情况？ 
