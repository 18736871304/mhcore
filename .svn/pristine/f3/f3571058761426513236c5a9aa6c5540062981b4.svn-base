            ...
            var iosSelect = new IosSelect(2,
                [iosProvinces, that.citysObject.iosCitys],
                {
                    ...
                    callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                        ...
                        $("#licenseNoPlat").text(selectOneObj.cpid)
                        //把 “请选择行驶区域” 改为选好的省市区
                        $("#"+id).val(selectOneObj.value + ' ' + selectTwoObj.id);
                        /*$this.siblings("input")[1].value = selectOneObj.codevalue;*/
                        $this.siblings("input")[0].value = selectTwoObj.id;
                ...
                [iosProvinces, that.citysObject.iosCitys],
                {
                    ...
                    callback: function (selectOneObj, selectTwoObj, selectThreeObj) {
                       ...
                       /* $("#"+id).val(selectOneObj.value+'              '+selectTwoObj.value);*/
                        $("#"+id).val(selectOneObj.value);
                        $("#my_insuredArea").val(selectTwoObj.value);
                        /*$this.siblings("input")[1].value = selectOneObj.codevalue;*/
                        $this.siblings("input")[0].value = selectTwoObj.id;
